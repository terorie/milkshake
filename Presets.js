...
Presets["Che - Escape.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      zone = below(sin(sin(49 * q7) * 14 * x - sin(36 * q7) * 14 * y), -0.2);
      zoom =
        1 +
        0.33 *
          q8 *
          ifcond(zone, -0.5 + 0.1 * sin(1.08 * q6), 0.5 + 0.1 * sin(0.96 * q6));
      zoomexp = exp(sin(ifcond(zone, q6, -q6)));
      rot = q8 * 0.03 * sin(q6 + q7 + q7 * zone);
    }
  },
  per_frame_code: function(_) {
    with (_) {
      ...
      le = 1.4 * bass_att + 0.1 * bass + 0.5 * treb;
      pulse = above(le, th);
      // pulsefreq = running average of interval between last 5 pulses
      pulsefreq = ifcond(
        equal(pulsefreq, 0),
        2,
        ifcond(pulse, 0.8 * pulsefreq + 0.2 * (time - lastpulse), pulsefreq)
      );
      lastpulse = ifcond(pulse, time, lastpulse);
      // bt = relative time; 0 = prev beat; 1 = expected beat
      bt = (time - lastbeat) / (0.5 * beatfreq + 0.5 * pulsefreq);
      // hccp = handcicap for th driven by bt
      hccp =
        0.03 / (bt + 0.2) +
        0.5 *
          ifcond(
            band(above(bt, 0.8), below(bt, 1.2)),
            pow(sin((bt - 1) * 7.854), 4) - 1,
            0
          );
      ...
      beatfreq = ifcond(
        equal(beatfreq, 0),
        2,
        ifcond(beat, 0.8 * beatfreq + 0.2 * (time - lastbeat), beatfreq)
      );
      // th = threshold
      th = ifcond(
        above(le, th),
        le + 114 / (le + 10) - 7.407,
        th + (th * 0.07) / (th - 12) + below(th, 2.7) * 0.1 * (2.7 - th)
      );
      ...
      q7 = ccl + 0.0002 * minorccl;
      q6 = 3.7 * ccl + 0.01 * minorccl;
      ob_size = 0.3 + 0.3 * sin(16 * ccl + 0.007 * minorccl);
      ib_a = 0.5 + 0.4 * sin(0.01 * minorccl + ccl);
      wave_r = 0.7 + 0.3 * sin(0.04 * ccl + 0.01 * minorccl);
      wave_g = 0.7 + 0.3 * sin(0.02 * ccl + 0.012 * minorccl);
      wave_b = 0.3 + 0.3 * sin(36 * ccl + 0.013 * minorccl);
      ib_r = 0.25 + 0.25 * sin(72 * ccl + 0.016 * minorccl);
      ib_g = 0.25 + 0.25 * sin(48 * ccl + 0.021 * minorccl);
      ib_b = 0.5 + 0.3 * sin(86 * ccl) + 0.2 * (0.028 * minorccl);

      echo_alpha = 0.5 + 0.5 * cos(68 * ccl + 0.0041 * minorccl);
      echo_zoom = exp(sin(13.7 * ccl + 0.017 * minorccl));
      echo_orient = ccl % 4;

      mvrot = ccl % 6;
      mv_r = ifcond(
        above(mvrot, 2),
        ifcond(above(mvrot, 4), 0.039, ifcond(equal(mvrot, 3), 0.137, 0.835)),
        ifcond(above(mvrot, 1), 0.651, ifcond(equal(mvrot, 0), 1, 0.773))
      );
      mv_g = ifcond(
        above(mvrot, 2),
        ifcond(above(mvrot, 4), 0.267, ifcond(equal(mvrot, 3), 0.886, 0.176)),
        ifcond(above(mvrot, 1), 0.804, ifcond(equal(mvrot, 0), 1, 0.38))
      );
      mv_b = ifcond(
        above(mvrot, 2),
        ifcond(above(mvrot, 4), 0.694, ifcond(equal(mvrot, 3), 0.776, 0.851)),
        ifcond(above(mvrot, 1), 0.114, ifcond(equal(mvrot, 0), 1, 0.145))
      );
    }
  },
  shapes: [],
...
Presets["Che - Terracarbon Stream.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      dqv = above(x, 0.5) - above(y, 0.5);
      rot = sin(sin(rad * (13 + 5 * sin(0.01 * q2)) + 0.06 * q2) * q1 * 0.01);
      zoom = 1 + ifcond(q3, dqv, 1) * 0.1 * sin(7 * ang + 0.03 * q2);
      zoom = ifcond(
        q4,
        ifcond(
          below(rad, 0.8 * sqr(sin(0.016 * q2))),
          0.75 + 0.4 * cos(0.021 * q2),
          zoom
        ),
        zoom
      );
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_r = 0.1 + 0.8 * sqr(sin(0.011 * thccl)) + 0.1 * sin(leccl * 0.061);
      wave_g = 0.1 + 0.8 * sqr(sin(0.013 * thccl)) + 0.1 * cos(leccl * 0.067);
      wave_b = 0.1 + 0.8 * sqr(cos(0.017 * thccl)) + 0.1 * sin(leccl * 0.065);

      ib_r = ib_r + 0.1 * sin(1.3 * time + 0.012 * leccl);
      ib_g = ib_g + 0.1 * sin(1.7 * time + 0.019 * leccl);
      ib_b = ib_b + 0.1 * sin(1.9 * time + 0.017 * leccl);
      mv_r = 0.5 * (ib_r + wave_r);
      mv_g = 0.5 * (ib_g + wave_g);
      mv_b = 0.5 * (ib_b + wave_b);
      mv_a = 0.5 * sqr(sin(0.01 * leccl + bccl));
...
Presets["CrystalHigh - mad ravetriping.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_r = 0.3 + 0.15 * (0.6 * sin(0.98 * time) + 0.4 * sin(1.047 * time));
      wave_r = ifcond(above(bass, 1.2), wave_r + 0.35, wave_r);
      wave_g = 0.3 + 0.15 * (0.6 * sin(0.835 * time) + 0.4 * sin(1.081 * time));
      wave_b = 0.3 + 0.15 * (0.6 * sin(0.814 * time) + 0.4 * sin(1.011 * time));
      wave_b = ifcond(above(wave_r, 0.8), wave_b - 0.25, wave_b);
      ib_a = max(sin(time), 0);
      ib_size = 0.01 + 0.002 * MyVolume;
      ob_a = 0.38 + 0.1 * MyVolume;
      ob_size = 0.05 - 0.004 * MyVoulme;
      ib_r = 0.34 + 0.2 * sin(time * 0.5413);
      ib_g = 0.34 + 0.2 * sin(time * 0.6459);
      ib_b = 0.34 + 0.2 * sin(time * 0.7354);
      ob_r = 0.34 + 0.2 * sin(time * 0.7251);
      ob_r = ifcond(above(bass, 1.2), ob_r + 0.35, ob_r);
      ob_g = 0.34 + 0.2 * sin(time * 0.5315);
      ob_b = 0.34 + 0.2 * sin(time * 0.6349);
      ob_b = ifcond(above(ob_r, 0.8), ob_b - 0.25, ob_b);
      zoom = max(sin(bass - bass_residual * 10), 0.2);
      rot = mid_residual * 2.5;
      bass_thresh =
        above(bass_att, bass_thresh) * 2 +
        (1 - above(bass_att, bass_thresh)) * ((bass_thresh - 1.3) * 0.96 + 1.3);
      bass_residual =
        equal(bass_thresh, 2) * 0.016 * sin(time * 7) +
        (1 - equal(bass_thresh, 2)) * bass_residual;
      mid_thresh =
        above(mid_att, mid_thresh) * 2 +
        (1 - above(mid_att, mid_thresh)) * ((mid_thresh - 1.3) * 0.92 + 1.3);
      mid_residual =
        equal(mid_thresh, 2) * 0.013 * sin(time * 7) +
        (1 - equal(mid_thresh, 2)) * mid_residual;
      monitor = zoom;
    }
  },
  shapes: [],
...
Presets["Aderrasi - Candy Avian.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      ib_b = 0;
      wave_x =
        wave_x + ifcond(above(wave_y, 0.75), 0.4 * sin(time), 0.15 * sin(time));
      wave_y = wave_y + 0.3 * cos(0.9 * time);
      cx =
        cx +
        ifcond(
          above(wave_x, 0.5),
...
Presets["Aderrasi - Making Time (Swamp Mix).milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      thresh =
        above(bass_att, thresh) * 2 +
        (1 - above(bass_att, thresh)) * ((thresh - 1.3) * 0.96 + 1.3);
      dx_r =
        equal(thresh, 2) * 0.015 * sin(5 * time) +
        (1 - equal(thresh, 2)) * dx_r;
      dy_r =
        equal(thresh, 2) * 0.015 * sin(6 * time) +
        (1 - equal(thresh, 2)) * dy_r;
      rot = rot + 2 * abs(0.9 * dy_r * bass) * sin(0.7 * time);
      zoom =
        zoom +
        10 *
          (0.2 * rad * (3 - (bass / cos(rad / 12)) * 2 * tan(12))) *
          (0.002 * sin(ang * (12 * sin(8 * bass))));
  ...
  per_frame_code: function(_) {
    with (_) {
      bass_tick =
        above(bass_att, bass_tick) * 2 +
        (1 - above(bass_att, bass_tick)) * ((bass_tick - 1.3) * 0.96 + 1.3);
      treb_tick =
        above(treb_att, treb_tick) * 2 +
        (1 - above(treb_att, treb_tick)) * ((treb_tick - 1.3) * 0.96 + 1.3);
      mid_tick =
        above(mid_att, mid_tick) * 2 +
        (1 - above(mid_att, mid_tick)) * ((mid_tick - 1.3) * 0.96 + 1.3);
      bass_shift =
        equal(bass_tick, 2) * 0.95 * sin(time * 5) +
        (1 - equal(bass_tick, 2)) * bass_shift;
      treb_shift =
        equal(treb_tick, 2) * 0.95 * sin(time * 5) +
        (1 - equal(treb_tick, 2)) * treb_shift;
      mid_shift =
        equal(mid_tick, 2) * 0.95 * sin(time * 5) +
        (1 - equal(mid_tick, 2)) * mid_shift;
...
Presets["Aderrasi - Flowing Form.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.4 * (0.6 * sin(0.933 * time) + 0.4 * sin(1.045 * time));
      wave_g = wave_g + 0.4 * (0.6 * sin(0.9 * time) + 0.4 * sin(0.956 * time));
      wave_b = wave_b + 0.4 * (0.6 * sin(0.91 * time) + 0.4 * sin(0.92 * time));
      zoom = zoom + 0.023 * (0.6 * sin(0.339 * time) + 0.4 * sin(0.276 * time));
      rot = rot + 0.03 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.579 * time));
    ...
    },
    {
      ...
      per_frame_code: function(_) {
        with (_) {
          ...
          r = 0.9 + sin(time / 2) * 0.5;
          g = 0.9 + sin(time / 2 + 2) * 0.5;
          b = 0.9 + sin(time / 2 + 4) * 0.5;

          r2 = 0.7 + sin(time / 2) * 0.5;
          g2 = 0.7 + sin(time / 2 + 2) * 0.5;
          b2 = 0.7 + sin(time / 2 + 4) * 0.5;
        }
      }
    },
    {
    ...
    },
    {
      ...
      per_frame_code: function(_) {
        with (_) {
          ...
          r = 0.7 + sin(time / 2) * 0.5;
          g = 0.7 + sin(time / 2 + 2) * 0.5;
          b = 0.7 + sin(time / 2 + 4) * 0.5;
        }
      }
    }
  ],
...
Presets["Fvese - The Tunnel (Final Stage Mix).milk"] = {
      ...
      zoom =
        ifcond(
          ...
          ifcond(
            equal(q2, 0),
            0.9 * (1 - x),
            ifcond(above(q3, 0), 0.9 * y, 0.9 * (1 - y))
          )
        ) +
        0.6 -
        0.13 * min(q3, 0.3);
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.45 * (0.5 * sin(time * 0.701) + 0.3 * cos(time * 0.438));
      wave_b =
        wave_b - 0.4 * (0.5 * sin(time * 4.782) + 0.5 * cos(time * 0.722));
      wave_g = wave_g + 0.4 * sin(time * 1.931);
      vol = 0.15 * (bass_att + bass + mid + mid_att);
      dx_r = ifcond(
        equal(q3, 0),
        ifcond(above(x, xpos), dx * q1 - xpos, dx + q2 - xpos),
        dx
      );
      dy_r = ifcond(
        equal(q3, 0),
        ifcond(above(y, ypos), dy * q1 - ypos, dy + q2 - ypos),
        dy
      );
      rot = rot + 0.05 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.479 * time));
      mytime = 0.7;
      q1 = sin(time * mytime * 4);
      q2 = cos(time * mytime * 2);
      q3 = abs(rad - 0.5) * (q2 * q1);
      xpos = 0.5 / vol;
      ypos = 0.5 / vol;
      wave_x = 0.5 + 0.1 * sin(time + rand(100) / 100);
      wave_y = 0.5 + 0.1 * cos(time + rand(100) / 100);
      ib_r = q3 + q2;
      ib_b = q2 + q1;
      ib_g = q1 + q3;
    }
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      xdir = ifcond(
        above(abs(xpos), xamp),
        -sign(xpos),
        ifcond(below(abs(xspeed), 0.1), 2 * above(xpos, 0) - 1, xdir)
      );
      ...
      ydir = ifcond(
        above(abs(ypos), yamp),
        -sign(ypos),
        ifcond(below(abs(yspeed), 0.1), 2 * above(ypos, 0) - 1, ydir)
      );
...
Presets["Idiot & Rovastar - Altars Of Madness 2 (X.42 Mix).milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      zoom = ifcond(above(box, 1), q1 * 0.1, zoom);
      rot =
        (ifcond(above(box, 1), sin(0.885 * time), 0) *
          (ang / 2 / 2 / 2 - rad) *
          sin(q5)) /
        2;
      dx = ifcond(
        above(box, 1),
        sin(0.542 * time),
        0.005 * sin((y - 0.5) * 96) + 0.005 * sin((y - 0.5) * 128)
      );
      dy = ifcond(
        above(box, 1),
        sin(0.581 * time),
        0.001 * cos((x - 0.5) * 128) + 0.001 * cos((x - 0.5) * 96)
      );
    }
  },
  per_frame_code: function(_) {
    with (_) {
      ...
      beatrate = ifcond(
        equal(beatrate, 0),
        1,
        ifcond(below(volume, 0.01), 1, beatrate)
      );
      lastbeat = ifcond(equal(lastbeat, 0), time, lastbeat);
      meanbass_att = 0.1 * (meanbass_att * 9 + bass_att);
      peakbass_att = ifcond(
        above(bass_att, peakbass_att),
        bass_att,
        peakbass_att
      );
      beat = ifcond(
        above(volume, 0.8),
        ifcond(
          below(peakbass_att - bass_att, 0.05 * peakbass_att),
          ifcond(above(time - lastbeat, 0.1 + 0.5 * (beatrate - 0.1)), 1, 0),
          0
        ),
        0
      );
      beatrate = max(
        ifcond(
          beat,
          ifcond(
            below(time - lastbeat, 2 * beatrate),
            0.1 * (beatrate * 9 + time - lastbeat),
            beatrate
          ),
          beatrate
        ),
      ...
      peakbass_att = ifcond(
        equal(beat, 0),
        ifcond(
          above(time - lastbeat, 2 * beatrate),
          peakbass_att * 0.95,
          peakbass_att * 0.995
        ),
        bass_att
      ...
      lastbeat = ifcond(beat, time, lastbeat);
      peakbass_att = max(
        ifcond(beat, bass_att, peakbass_att),
        1.1 * meanbass_att
      );
      ...
      echo_zoom =
        echo_zoom - 0.3 * sin(Time * (q5 / 2 / 2 / 2 / 2 / 2 / 2 / 2));
      //echo_alpha=1;
    }
  },
  shapes: [],
  ...
  per_frame_code: function(_) {
    with (_) {
      vol_att =
        treb_att * 0.25 +
        mid_att * 0.25 +
        (bass_att * 0.25 + 0.5 * sin(vol)) / vol;
      vol = bass + treb + mid;
      new_bass = bass * 0.25 + 0.5 * sin(bass_att * 0.25);
      new_treb = treb * 0.25 + 0.5 * sin(treb_att * 0.25);
      new_mid = mid * 0.25 + 0.4 * sin(mid_att * 0.25);
      bass_c = q1 - 1 * sin(bass_stt & (time * 0.54));
      treb_c = q2 - 1 * sin(treb_att & (time * 0.44));
      mid_c = q3 - 1 * sin(mid_att & (time * 0.24));
      vol_c = q4 - 1 * sin(vol_att & (time * 0.64));
      q1 = sin((bass - new_bass) & (time * 0.63));
      q2 = sin((treb - new_treb) & (time * 0.43));
      q3 = sin((mid - new_mid) & (time * 0.23));
      q4 = sin(vol & (time * 0.65));
      q5 = bass_c;
      q6 = treb_c;
      q7 = mid_c;
      q8 = vol_c;
  ...
  shapes: [
    {
      ...
      per_frame_code: function(_) {
        with (_) {
          textured = 1;
          tex_ang = tex_ang + 1 * sin(time * 0.65 * q2);
          ang = ang + 1 * sin(time * 0.62);
          x = 0.5 - 0.3 * sin(time * 0.34);
          y = 0.5 + 0.3 * sin(time * 0.53);
          rad = rad - 0.5 * sin(time * 0.53);
        }
      }
    },
    {
      ...
      per_frame_code: function(_) {
        with (_) {
          textured = 1;
          tex_ang = tex_ang + 1 * sin(time * 0.23 * q4);
          ang = ang + 1 * sin(time * 0.75);
          x = 0.5 - 0.3 * sin(time * 0.12);
          y = 0.5 + 0.3 * sin(time * 0.65);
          rad = rad + 0.5 * sin(time * 0.75);
        }
      }
    },
    {
      ...
      per_frame_code: function(_) {
        with (_) {
          textured = 1;
          tex_ang = tex_ang + 1 * sin(time * 0.34 * q3);
          ang = ang + 1 * sin(time * 0.12);
          x = 0.5 - 0.3 * sin(time * 0.23);
          y = 0.5 + 0.3 * sin(time * 0.56);
          rad = rad + 0.5 * sin(time * 0.12);
        }
      }
    },
    {
      ...
      per_frame_code: function(_) {
        with (_) {
          textured = 1;
          tex_ang = tex_ang + 1 * sin(time * 0.12 * q6);
          ang = ang + 1 * sin(time * 0.65);
          x = 0.5 - 0.3 * sin(time * 0.54);
          y = 0.5 + 0.3 * sin(time * 0.23);
          rad = rad + 0.4 * sin(time * 0.43);
        }
      }
    }
  ],
...
Presets["Idiot - Texture Boxes (Remix).milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      new_treb = treb * 0.25 + 0.5 * sin(treb_att * 0.25);
      new_mid = mid * 0.25 + 0.4 * sin(mid_att * 0.25);
      bass_c = q1 - 1 * sin(bass_att & (time * 0.54));
      treb_c = q2 - 1 * sin(treb_att & (time * 0.44));
      mid_c = q3 - 1 * sin(mid_att & (time * 0.24));
      vol_c = q4 - 1 * sin(vol_att & (time * 0.64));
      q1 = sin((bass - new_bass) & (time * 0.63));
  ...
  shapes: [
    {
      ...
      per_frame_code: function(_) {
        with (_) {
          tx = 0 + 1 * sin(q1);
          textured = ifcond(below(0.5, tx), 0, 1);
          tex_ang = tex_ang + 1 * sin(time * 0.65 * q2);
          ang = ang + 1 * sin(time * 0.62);
          x = 0.5 - 0.3 * sin(time * 0.34);
          y = 0.5 + 0.3 * sin(time * 0.53);
...
Presets["Idiot24-7 - Ascending to heaven 2.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r = wave_r + 1 * (0.6 * sin(0.933 * time) + 0.4 * sin(1.045 * time));
      wave_b = wave_b + 1 * (1.6 * sin(1.9 * time) + 0.4 * sin(0.956 * time));
      wave_g = wave_g + 1 * (1.5 * sin(1.9 * time) + 0.4 * sin(1 * time));
      rot = 0.14 * sin(time);
    }
  },
  shapes: [],
...
Presets["Illusion & Che - Return Of The King.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      dx =
        0.01 *
        sin((20 + 10 * sin(q1 * 1.5)) * (y + 0.2 * sin(q1 * 0.7))) *
        bass;
      dy = 0.01 * sin((20 + 10 * sin(q1)) * (x + 0.2 * sin(q1 * 0.77))) * bass;
    }
  },
  per_frame_code: function(_) {
    with (_) {
      wave_r = 0.15 * (0.3 * sin(0.875 * time) + 0.2 * sin(0.315 * time));
      wave_g = 0.85 * (0.1 * sin(0.2 * time) + 0.1 * sin(1.025 * time));
      wave_b = 0.25 * (0.9 * sin(0.41 * time) + 0.6 * sin(0.15 * time));
    }
  },
  shapes: [],
  waves: []
  ...
  per_pixel_code: function(_) {
    with (_) {
      dx =
        ...
        3;
      dy =
        0.01 * sin((20 + 10 * sin(q1)) * (x + 0.2 * sin(q1 * 0.77))) * bass * 2;
      sy = sy + 0.01 * bass_att;
    }
  },
  per_frame_code: function(_) {
    with (_) {
      wave_r = 0.15 * (0.3 * sin(0.875 * time) + 0.2 * sin(0.315 * time));
      wave_g = 0.15 * (0.1 * sin(0.2 * time) + 0.1 * sin(1.025 * time));
      wave_b = 0.15 * (0.5 * sin(0.41 * time) + 0.6 * sin(0.15 * time));
    }
  },
  shapes: [],
  waves: []
...
Presets["Illusion & Unchained - Frozen Eye 1.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_r =
        wave_r +
        0.25 * (0.6 * sin(0.784 * time) + 0.4 * sin(0.986 * time)) * state;
      wave_g =
        wave_g +
        0.25 *
          (0.6 * sin(0.671 * time) + 0.4 * sin(1.164 * time)) *
          (4 - state);
      wave_b =
        wave_b +
        0.25 *
          (0.6 * sin(1.423 * time) + 0.4 * sin(0.687 * time)) *
          (4 / state);
      wave_y = ifcond(
        equal(state, 1),
        wave_y + rand(10) * 0.1 * sin(time * 3),
        wave_y
      );
      bass_effect = ifcond(above(bass_att, 1.4), pow(1.1, bass_att), 1);
      treb_effect = ifcond(above(treb_att, 1.4), pow(0.97, treb_att), 1);
      net_effect = ifcond(
        above(bass_att, 0.8 * treb_att),
        bass_effect,
        treb_effect
      );
  ...
  per_pixel_code: function(_) {
    with (_) {
      box =
        1 -
        rad +
        ((0.5 * abs(x * 3 - 0.4 * sin(q1))) % 2) +
        ((0.5 * abs(y * 3 + 0.4 * sin(q1))) % 2);
...
Presets["Phat_Eo.S. - our own personal demon.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      counter1 = ifcond(
        equal(counter2, 1),
        ifcond(equal(counter1, 1), 0, counter1 + 0.2),
        1
      );
      counter2 = ifcond(
        equal(counter1, 1),
        ifcond(equal(counter2, 1), 0, counter2 + 0.2),
        1
      );
      cdelay1 = ifcond(
        equal(cdelay2, 1),
        1,
        ifcond(
          equal(colorcounter % 2, 1),
          ifcond(equal(counter1, 1), 2, 0),
          ifcond(equal(counter2, 1), 2, 0)
        )
      );
      cdelay2 = ifcond(equal(cdelay1, 2), 1, 0);
      colorcounter = ifcond(
        above(colorcounter, 7),
        0,
        ifcond(equal(cdelay1, 1), colorcounter + 1, colorcounter)
      );
      ib_r =
        0.5 *
        ifcond(
          equal(colorcounter, 1),
          1,
          ifcond(
            equal(colorcounter, 2),
            1,
            ifcond(
              equal(colorcounter, 3),
              1,
              ifcond(
                equal(colorcounter, 4),
                sin(counter2 + 2.1),
                ifcond(
                  equal(colorcounter, 5),
                  0,
                  ifcond(equal(colorcounter, 6), 0, sin(counter1))
                )
              )
            )
          )
            ...
            ifcond(
              ...
              ifcond(
                ...
                ifcond(
                  equal(colorcounter, 5),
                  1,
                  ifcond(equal(colorcounter, 6), sin(counter2 + 2), 0)
                )
              )
            )
          )
          ...
          ifcond(
            ...
            ifcond(
              ...
              ifcond(
                equal(colorcounter, 5),
                sin(counter1),
                ifcond(equal(colorcounter, 6), 1, 1)
              )
            )
          )
        )
...
Presets["Phat_Rovastar - What_does_your_soul_look_like.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ib_r =
        0.5 +
        5.499 * (0.6 * sin((0.933 * time) / 3) + 0.4 * sin((1.045 * time) / 3));
      ib_g =
        0.5 + 5 * (0.6 * sin((0.9 * time) / 3) + 0.4 * sin((0.956 * time) / 3));
      ib_b =
        0.5 +
        5.499 * (0.6 * sin((0.91 * time) / 3) + 0.4 * sin((0.92 * time) / 3));
      wave_a = 0;
      decay = 1;
      zoom = 1;
      rot = 0;
...
Presets["Pithlit & Illusion - Symetric pattern.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      pre_zoom =
        zoom -
        0.07 * acos(y * 2 - 1) * sin(time * 1.2 * q1) * zoom -
        0.07 * acos(x * 2 - 1) * sin(time * 1.1 * q1);
      zoom = ifcond(above(abs(zoom - 1), 0.04), pre_zoom, 0.99);
      rot = ifcond(above(abs(zoom - 1), 2), -0.4 + 0.2 * q1, 0);
    }
  },
  per_frame_code: function(_) {
    with (_) {
      ...
      mv_b = 0.6 - treb_att;
      mv_g = 0.5 - mid_att;
      rot = rot + 0.04 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.539 * time));
...
Presets["Rovastar & Unchained - Centre Of Gravity.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      rot = ifcond(
        above(q6, 0),
        (sqrt(2) * 0.5 - rad) * 0.18 * q5,
        0.2 * q5 * sin(rad * 2.133 * q7)
      );
      zoom = ifcond(
        above(q2, 0),
        zoom,
        ifcond(
          above(q3, 0),
          1 + 0.07 * sin(q4 * 0.2 * radix),
          1 + 0.07 * cos(radix * 10 * q4)
        )
      );
      zoomexp =
        ifcond(
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      chaos = 0.9 + 0.1 * sin(pulse);
      bass_thresh =
        above(bass_att, bass_thresh) * 2 +
        (1 - above(bass_att, bass_thresh)) *
          ((bass_thresh - 1.6) * chaos + 1.6);
      bass_flop = abs(bass_flop - equal(bass_thresh, 2));
      treb_thresh =
        above(treb_att, treb_thresh) * 2 +
        (1 - above(treb_att, treb_thresh)) *
          ((treb_thresh - 1.6) * chaos + 1.6);
      treb_flop = abs(treb_flop - equal(treb_thresh, 2));
      mid_thresh =
        above(mid_att, mid_thresh) * 2 +
        (1 - above(mid_att, mid_thresh)) * ((mid_thresh - 1.6) * chaos + 1.6);
      ...
      bass_residual =
        bass_changed * sin(pulse * 3) + bnot(bass_changed) * bass_residual;
      treb_residual =
        treb_changed * sin(pulse * 3) + bnot(treb_changed) * treb_residual;
      mid_residual =
        mid_changed * sin(pulse * 3) + bnot(mid_changed) * mid_residual;
      pulse = ifcond(
        above(abs(pulse), 3.14),
        -3.14,
        pulse + (bass_thresh + mid_thresh + treb_thresh) * 0.0035
      );
      entropy = ifcond(
        bass_changed * mid_changed * treb_changed,
        (1 + bass_flop + treb_flop + mid_flop) * (1 + rand(3)),
        entropy
      );
      q1 = mid_residual;
      q2 = bass_residual;
      q3 = treb_residual;
      q4 = sin(pulse);
      q5 = cos(pulse * (0.5 + 0.1 * entropy));
      q6 = sin(pulse * (0.5 + pow(0.25, entropy)));
      q7 =
        above(q1, 0) +
        above(q2, 0) +
        above(q3, 0) +
        above(q3, 0) * treb_flop +
        above(q2, 0) * bass_flop +
        above(q1, 0) * mid_flop;
      q8 = entropy;
      ...
      ob_a = 0.25 + 0.25 * sin(q2 + q3 * 2.14);
      ib_a = 0.25 + 0.25 * sin(q2 * 2.14 + q3);
      ob_size = 0.1 + 0.1 * sin(q3 * 3 + q1);
      ib_size = 0.1 + 0.1 * sin(q1 * 3 + q3);
      wave_mystery = 0.5 * q6;
      warp = 0;
      wave_mode = q8 % 7;
      mv_x = 1.25;
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      thresh =
        ...
        (1 - above(bass_att, thresh)) * ((thresh - 1.3) * 0.96 + 1.3);
      dx_r =
        equal(thresh, 2) * 0.002 * sin(5 * time) +
        (1 - equal(thresh, 2)) * dx_r;
      dy_r =
        equal(thresh, 2) * 0.002 * sin(6 * time) +
        (1 - equal(thresh, 2)) * dy_r;
  ...
  per_pixel_code: function(_) {
    with (_) {
      box =
        0.7 * sqrt(2) -
        rad +
        ((0.8 * abs(x * 3 - 0.4 * sin(q1))) % 2) +
        ((0.8 * abs(y * 3 + 0.4 * sin(q1))) % 2);
      ...
      dx = ifcond(
        above(box, 1),
        dx,
        q4 * sin((y - 0.5) * q3) + q5 * sin((y - 0.5) * q2)
      );
      dy = ifcond(
        above(box, 1),
        dy,
        q6 * cos((x - 0.5) * q2) + q7 * cos((x - 0.5) * q3)
      );
    }
  },
  init_code: function(_) {
...
Presets["Rovastar - Explosive Minds.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      q1 = zoom + pow(bass + bass_att, 3) * 0.005 - 0.02;
    }
  },
  shapes: [],
  waves: []
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      beatrate =
        equal(beatrate, 0) +
        (1 - equal(beatrate, 0)) *
          (below(volume, 0.01) + (1 - below(volume, 0.01)) * beatrate);
      ...
      beat =
        above(volume, 0.8) *
        below(peakbass_att - bass_att, 0.05 * peakbass_att) *
        above(time - lastbeat, 0.1 + 0.5 * (beatrate - 0.1));
      beatrate = max(
        ifcond(
          beat,
          ifcond(
      ...
      peakbass_att =
        ...
        (1 - beat) *
          peakbass_att *
          (above(time - lastbeat, 2 * beatrate) * 0.95 +
            (1 - above(time - lastbeat, 2 * beatrate)) * 0.995);
      lastbeat = beat * time + (1 - beat) * lastbeat;
      peakbass_att = max(peakbass_att, 1.1 * meanbass_att);
      wave_x = xpos + 0.5;
      wave_y = 1 - (ypos + 0.5);
      wave_r = 0.5 + 0.499 * (0.6 * sin(0.98 * time) + 0.4 * sin(1.047 * time));
      wave_g =
        0.5 + 0.499 * (0.6 * sin(0.835 * time) + 0.4 * sin(1.081 * time));
      wave_b =
        0.5 + 0.499 * (0.6 * sin(0.814 * time) + 0.4 * sin(1.011 * time));
      wave_mystery =
        -0.17 + 0.03 * (0.6 * sin(0.637 * time) + 0.4 * sin(0.949 * time));
      ...
      movement =
        ...
        0.4 *
          ((bass +
            bass_att +
            0.1 * pow(bass + 0.6 * bass_att + 0.2 * treb_att, 3)) /
            fps);
...
Presets["Rovastar - Forgotten Moon.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_r =
        wave_r + 0.35 * (0.6 * sin(0.98 * time) + 0.4 * sin(1.047 * time));
      wave_g =
        wave_g + 0.35 * (0.6 * sin(0.835 * time) + 0.4 * sin(1.081 * time));
      wave_b =
        wave_b + 0.35 * (0.6 * sin(0.814 * time) + 0.4 * sin(1.011 * time));
      q8 =
        oldq8 +
        0.0002 *
          (pow(
...
Presets["Rovastar - Magic Carpet.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_a = 0;
      decay = 0.99 + abs(0.01 * sin(0.321 * q8));
    }
  },
  shapes: [],
  waves: []
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      rot = ifcond(
        above(q4, 0),
        rad * 0.2 * q5,
        rot + 0.3 * sin(radix * 3.14 * (q1 + q2 + q3))
      );
      zoom = ifcond(
        above(q2, 0),
        zoom - cos(radix * 3.14 * q2) * 0.1,
        ifcond(above(q3, 0), 1 + q1 * 0.05, 1 + 0.07 * cos(radix * 10 * q1))
      );
    }
  },
  per_frame_code: function(_) {
    with (_) {
      ...
      entropy = ifcond(
        bnot(entropy),
        2,
        ifcond(equal(pulse, -20), 1 + rand(3), entropy)
      );
      bass_thresh =
        above(bass_att, bass_thresh) * 2 +
        (1 - above(bass_att, bass_thresh)) *
          ((bass_thresh - 1.3) * chaos + 1.3);
      bass_flop = abs(bass_flop - equal(bass_thresh, 2));
      treb_thresh =
        above(treb_att, treb_thresh) * 2 +
        (1 - above(treb_att, treb_thresh)) *
          ((treb_thresh - 1.3) * chaos + 1.3);
      treb_flop = abs(treb_flop - equal(treb_thresh, 2));
      mid_thresh =
        above(mid_att, mid_thresh) * 2 +
        (1 - above(mid_att, mid_thresh)) * ((mid_thresh - 1.3) * chaos + 1.3);
      mid_flop = abs(mid_flop - equal(mid_thresh, 2));
      bass_changed = bnot(equal(old_bass_flop, bass_flop));
      mid_changed = bnot(equal(old_mid_flop, mid_flop));
      treb_changed = bnot(equal(old_treb_flop, treb_flop));
      bass_residual =
        bass_changed * sin(pulse * 0.1 * entropy) +
        bnot(bass_changed) * bass_residual;
      treb_residual =
        treb_changed * sin(pulse * 0.1 * entropy) +
        bnot(treb_changed) * treb_residual;
      mid_residual =
        mid_changed * sin(pulse * 0.1 * entropy) +
        bnot(mid_changed) * mid_residual;
      pulse = ifcond(
        above(abs(pulse), 20),
        -20,
        pulse +
          (bass_thresh + mid + thresh + treb_thresh) * 0.052 +
          -(bass + treb + mid) * 0.01
      );
      q1 = mid_residual;
      q2 = bass_residual;
      ...
      q4 = sin(pulse);
      q5 = sin(pulse / 2);
      wave_r = wave_r + 0.5 * bass_residual;
      wave_r = wave_g + 0.5 * mid_residual;
      wave_r = wave_b + 0.5 * treb_residual;
      ...
      ob_a = 0.05 + 0.05 * cos(wave_r + pulse * 0.03);
      ob_size = 0.2 + 0.2 * treb_residual;
      ib_r = ifcond(bass_flop, ob_b, ob_g);
      ib_b = ifcond(treb_flop, ob_g, ob_r);
      ib_g = ifcond(mid_flop, ob_r, ob_b);
      ib_size = ob_size * cos(wave_g + pulse * 0.4) * 0.5;
    }
  },
  shapes: [],
  waves: []
...
Presets["Aderrasi - Aimless (Gravity Directive Mix).milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_mystery = wave_mystery + 0.0 * sin(time);
      turn =
        above(bass_att, turn) * 2 +
        (1 - above(bass_att, turn)) * ((turn - 1.3) * 0.96 + 1.3);
      turnr =
        equal(turn, 2) * 0.089 * sin(time * 6.6) + (1 - equal(turn, 2)) * turnr;
      simp =
        simp * 0.35 * sin(1.2 * time) -
        0.62 * sin(0.7 * time) +
        1.5 * sin(turn);
    ...
    with (_) {
      ...
      zoom =
        ...
        bass_att *
          abs(
            0.33 *
              (0.6 * sin(1.52 * time) * (0.25 - rad) +
                (0.5 - rad) * 0.8 * cos(2.2 * time) +
                (2 * orb + (2 - rad)) * 0.7 * sin(time))
          ) *
          0.4;
      ...
      dy =
        ...
        0.005 *
          sin(
            cos(x * time) *
              1.76 *
              sin(0.52 * time * cos(max(0.075 * bass_att, 0.0005 * time)))
          );
      dx =
        dx +
        0.005 *
          cos(
            sin(y * time) *
              1.54 *
              sin(0.79 * time * sin(max(0.075 * treb_att, 0.0005 * time)))
          );
    }
  },
  per_frame_code: function(_) {
  ...
  per_pixel_code: function(_) {
    with (_) {
      zoom =
        zoom +
        0.05 *
          (sin(abs(50 * sin(0.1 * time)) * rad) *
            sin(sin(time * 2 * sin(24 * ang) * -rad)) *
            3 *
            cos(rad));
      ...
      cx =
        ...
        1.1 *
          (0.99 * (0.5 - rad)) *
          sin(0.733 * time) *
          below(sin(time), cos(time));
      cy =
        cy +
        1.1 *
          (0.99 * (0.5 - rad)) *
          cos(0.953 * time) *
          above(sin(time), cos(0.5 * time));
    }
  },
  per_frame_code: function(_) {
    with (_) {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      orb =
        0.5 -
        0.5 *
          sin(12 * sin(rad * time + ang) * (ang * time + rad) * time + rad) -
        2 * rad;
        ...
        0.1 *
          sin(
            0.6 *
              cos(
                0.33 *
                  (0.6 * sin(1.52 * time) * orb +
                    orb * 0.8 * cos(2.2 * time) +
                    cos(orb) * 0.7 * sin(time))
              )
          ) *
          (above(zoom, 0.3) * 0);
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      dy =
        dy -
        sin((1 + x) * time * 0.94) *
          (0.005 * above(y, sin(1.14 * time + 0.02 * treb_att)));
      dx =
        dx +
        sin((0.25 - y) * time * 0.97) *
          (0.005 * above(x, cos(1.2 * time + 0.02 * bass_att)));
    }
  },
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.35 * sin(1.4 * time) + 0.15 * sin(2.5 * time + 2 * mid);
      wave_g =
        wave_g + 0.35 * sin(1.7 * time) + 0.15 * sin(2.11 * time + 2.2 * treb);
      wave_b =
        wave_b + 0.35 * sin(1.84 * time) + 0.15 * sin(2.3 * time + 2 * bass);
      //wave_y = wave_y + 0.24*sin(2.5*time);
      wave_x =
        0.75 + 0.45 * sin(sin(0.5 * bass_att - 0.4 * treb_att) * sin(time));
...
Presets["Aderrasi - Antique Abyss.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      dx =
        dx + 1.5 * dx_r * (rad * cos(5 * bass_att)) * (0.6 * rad - 0.7 - rad);
      rot =
        rot +
        abs(0.8 * (0.7 * sin(bass * treb) * x - 0.033 * cos(ang)) * (1 - rad));
    }
  },
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r +
        (0.35 * sin(1.4 * time * bass) + 0.25 * sin(2.5 * time)) *
          4 *
          treb *
          time;
      wave_g =
        wave_g +
        (0.35 * sin(1.7 * time * mid) - 0.25 * sin(1.11 * time)) *
          4 *
          bass *
          time;
      wave_b =
        wave_b +
        (0.35 * sin(1.84 * time * treb) + 0.25 * sin(2.3 * time)) *
          4 *
          mid *
          time;
      warp = 0;
...
Presets["Aderrasi - Ashes Of Air (Remix).milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      zoom =
        zoom +
        0.25 * (0.05 * bass_att + sin(sin(time + rad)) * 0.3 - cos(rad) * 0.1);
      rot = 0.06 * sin(rad);
    ...
    with (_) {
      ...
      zoom =
        ...
        0.2 *
          (1.5 - rad) *
          sin((bass / 2) * treb_att) *
          (rad * 2 * (rad * abs(sin(9 * ang))));
      rot = rot + dy_r * (2 - zoom) * 0.3 * cos(bass) * 20;
      rot =
        rot -
        0.4 * (rad * cos(abs(12 * ang))) * below(rad, 0.3 + 0.4 * sin(bass));
...
Presets["Aderrasi - Chromatic Abyss (The Other Side).milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      warp =
        warp + ifcond(above(rad, 0.56 + 0.05 * sin(time)), +0.5 * sin(rad), 0);
    }
  },
  per_frame_code: function(_) {
    with (_) {
...
Presets["Aderrasi - Contortion (Xenomorph Mix).milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      zoom =
        zoom - 0.015 * (0.65 - 0.25 * sin((dx_r + dy_r) * 20 * bass) + rad);
      cx =
        cx +
        0.45 *
          sin(time) *
          (0.75 * sin(1.25 * time * dy_r) * cos(0.74 * sin(dx_r * 2 * time)));
      cy =
        cy +
        0.45 *
          cos(time) *
          (0.75 * cos(1.6 * time * dx_r) * sin(0.74 * cos(dy_r * 2 * time)));
    }
  },
  per_frame_code: function(_) {
    with (_) {
    ...
    with (_) {
      ...
      zoom =
        ...
        abs(
          0.6 *
            sin(
              (sin(cos(time) + 0.5 * sin(1.6 * bass) - 0.44 * cos(1.1 * mid)) +
                sin(-rad)) *
                (sin(bass) * (0.5 - rad))
            )
        );
      ...
      dx =
        ...
        abs(
          0.005 *
            (1.2 * cos(bass * 0.73 * time) +
              1.2 * sin((0.5 - rad) * 2.1 * time))
        );
      dy =
        dy +
        abs(
          0.005 *
            (1.2 * sin(bass * 0.73 * time) +
              1.2 * cos((0.5 - rad) * 1.3 * time))
        );
    }
  },
  per_frame_code: function(_) {
...
Presets["Aderrasi - Multiviola.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.55 * sin(2.4 * mid * time) + 0.925 * cos(2.25 * bass) * time;
      wave_g =
        wave_g + 0.55 * cos(3.7 * treb * time) + 0.925 * tan(1.11 * mid) * time;
      wave_b =
        wave_b +
        0.55 * tan(2.84 * bass * time) +
        0.925 * sin(3.3 * treb) * -time;
      warp = 0;
...
Presets["Bmelgren & Krash - Rainbow Orb Peacock (Lonely Signal Gone .milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      rot =
        rot +
        ifcond(equal(sin(ang), 1), rot, sin(1 - rad) / sqr(bass_att * 1.5));
    }
  },
  per_frame_code: function(_) {
    with (_) {
      ...
      shift = ifcond(
        above(shift, 0),
        0,
        ifcond(below(shift, -0.1), -0.1, shift)
      );
...
Presets["bmelgren - Take this highway.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      rot = 0.1 * pow(ang, 3);
      zoom = sin(pow(rad, 3)) + 0.6 * mid_att;
    }
  },
  per_frame_code: function(_) {
    with (_) {
...
Presets["Fvese - Window Reflection 6.milk"] = {
                      ...
                      0.25 * (1 - dy) +
                        ifcond(
                          ...
                          ifcond(
                            below(q8, q7),
                            0.2 * (1 - dx),
                            ifcond(equal(q9, q6), 0.3 * dy, 0.2 * (1 - dy))
                          )
                        )
                    )
                  )
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      q3 = bass_eff + abs(rad + 0.5) + q2 * q5;
      q4 = bass_thresh + abs(0.9 * 5) * (dx_r * dy_r) * (dx * dy);
      q5 = bass_tresh + cos(0.2 * 2) * (dx_r * dy_r);
      q6 = bass_thresh + 0.1 * atan(abs(-rad + 0.5)) * q1;
      q7 = ifcond(above(bass + bass_att, 2), -1.5 + bass + bass_att, 0);
      q8 = below(rad - 0.1 * x, 0.18);
      q9 = ifcond(above(rad, 0.5), 0.9 + rad, 0.5 + ((bass * 3) % 1000) * 0.1);
      dx = q8;
      zoom = q9 + 0.4;
      monitor = zoom;
    }
...
Presets["Geiss & Rovastar - Notions Of Tonality 2.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      mv_r = wave_r + 0.35 * (0.6 * sin(0.98 * time) + 0.4 * sin(1.047 * time));
      mv_g =
        wave_g + 0.35 * (0.6 * sin(0.835 * time) + 0.4 * sin(1.081 * time));
      mv_b =
        wave_b + 0.35 * (0.6 * sin(0.814 * time) + 0.4 * sin(1.011 * time));
      q1 =
        cx * 2 - 1 + 0.62 * (0.6 * sin(0.474 * time) + 0.4 * sin(0.394 * time));
      q2 =
        cy * 2 - 1 + 0.62 * (0.6 * sin(0.413 * time) + 0.4 * sin(0.323 * time));
      q3 =
        cx * 2 -
        1 +
        0.62 * (0.6 * sin(0.274 * -time) + 0.4 * sin(0.464 * time));
      q4 =
        cy * 2 -
        1 +
        0.62 * (0.6 * sin(0.334 * time) + 0.4 * sin(0.371 * -time));
...
Presets["Geiss & Rovastar - Tokamak (Naked Intrusion Mix).milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      mv_r = mv_r + 0.2 * (0.6 * sin(0.98 * time) + 0.4 * sin(1.047 * time));
      mv_g = mv_g + 0.2 * (0.6 * sin(0.835 * time) + 0.4 * sin(1.081 * time));
      mv_b = mv_b + 0.2 * (0.6 * sin(0.814 * time) + 0.4 * sin(1.011 * time));
      q1 =
        cx * 2 - 1 + 0.6 * (0.6 * sin(0.374 * time) + 0.4 * sin(0.294 * time));
      q2 =
        cy * 2 - 1 + 0.6 * (0.6 * sin(0.393 * time) + 0.4 * sin(0.223 * time));
      ob_r = 1 - 0.4 * abs(q1);
      ob_g = 0.3 * abs(q2);
      ob_b = 0.4 * abs(q1);
      ...
      wave_r =
        wave_r + 0.4 * (0.6 * sin(0.514 * time) + 0.4 * sin(1.211 * time));
      wave_b = wave_b + 0.4 * (0.6 * sin(0.714 * time) + 0.4 * sin(q2));
      wave_g = wave_g + 0.4 * (0.6 * sin(10 * q1) + 0.4 * sin(10 * q2));
    }
  },
  shapes: [],
  waves: []
...
Presets["Geiss - Cosmic Dust 2.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.65 * (0.6 * sin(1.437 * time) + 0.4 * sin(0.97 * time));
      wave_g =
        wave_g + 0.65 * (0.6 * sin(1.344 * time) + 0.4 * sin(0.841 * time));
      wave_b =
        wave_b + 0.65 * (0.6 * sin(1.251 * time) + 0.4 * sin(1.055 * time));
      rot = rot + 0.01 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.579 * time));
      cx = cx + 0.21 * (0.6 * sin(0.374 * time) + 0.4 * sin(0.294 * time));
      cy = cy + 0.21 * (0.6 * sin(0.393 * time) + 0.4 * sin(0.223 * time));
      dx = dx + 0.01 * (0.6 * sin(0.234 * time) + 0.4 * sin(0.277 * time));
      dy = dy + 0.01 * (0.6 * sin(0.284 * time) + 0.4 * sin(0.247 * time));
      ...
      dy_residual =
        equal(bass_thresh, 2) * 0.012 * sin(time * 9) +
        (1 - equal(bass_thresh, 2)) * dy_residual;
    }
  },
  shapes: [],
  waves: []
...
Presets["Geiss - Cruzin'.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.25 * (0.6 * sin(10.937 * time) + 0.4 * sin(1.47 * time));
      wave_g =
        wave_g + 0.3 * (0.6 * sin(11.344 * time) + 0.4 * sin(1.041 * time));
      wave_b =
        wave_b + 0.25 * (0.6 * sin(21.251 * time) + 0.4 * sin(1.355 * time));
      rot = rot + 0.004 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.579 * time));
      cx = cx + 0.11 * (0.6 * sin(0.374 * time) + 0.4 * sin(0.294 * time));
      cy = cy + 0.11 * (0.6 * sin(0.393 * time) + 0.4 * sin(0.223 * time));
      decay = decay - 0.01 * equal(frame % 6, 0);
    }
  },
  shapes: [],
...
Presets["Geiss - Downward Spiral.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.12 * (0.6 * sin(0.733 * time) + 0.4 * sin(0.345 * time));
      wave_g =
        wave_g + 0.12 * (0.6 * sin(0.6 * time) + 0.4 * sin(0.456 * time));
      wave_b = wave_b + 0.1 * (0.6 * sin(0.51 * time) + 0.4 * sin(0.55 * time));
    }
  },
  shapes: [],
  waves: []
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_b =
        wave_b + 0.35 * (0.6 * sin(0.814 * time) + 0.4 * sin(1.011 * time));
      q1 =
        cx * 2 - 1 + 0.62 * (0.6 * sin(0.374 * time) + 0.4 * sin(0.294 * time));
      q2 =
        cy * 2 - 1 + 0.62 * (0.6 * sin(0.393 * time) + 0.4 * sin(0.223 * time));
      q3 =
        cx * 2 -
        1 +
        0.62 * (0.6 * sin(0.174 * -time) + 0.4 * sin(0.364 * time));
      q4 =
        cy * 2 -
        1 +
        0.62 * (0.6 * sin(0.234 * time) + 0.4 * sin(0.271 * -time));
      decay = decay - 0.01 * equal(frame % 5, 0);
    }
  },
  shapes: [],
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_b =
        wave_b + 0.35 * (0.6 * sin(0.814 * time) + 0.4 * sin(1.011 * time));
      q1 =
        cx * 2 - 1 + 0.32 * (0.6 * sin(0.374 * time) + 0.4 * sin(0.294 * time));
      q2 =
        cy * 2 - 1 + 0.52 * (0.6 * sin(0.393 * time) + 0.4 * sin(0.223 * time));
      q3 =
        cx * 2 -
        1 +
        0.32 * (0.6 * sin(0.174 * -time) + 0.4 * sin(0.364 * time));
      q4 =
        cy * 2 -
        1 +
        0.52 * (0.6 * sin(0.234 * time) + 0.4 * sin(0.271 * -time));
      decay = decay - 0.01 * equal(frame % 5, 0);
    }
  },
  shapes: [],
...
Presets["Geiss - Eggs.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      zoom = zoom + 0.023 * (0.6 * sin(0.339 * time) + 0.4 * sin(0.276 * time));
      rot = rot + 0.03 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.579 * time));
      cx = cx + 0.07 * (0.6 * sin(0.374 * time) + 0.4 * sin(0.294 * time));
      cy = cy + 0.07 * (0.6 * sin(0.393 * time) + 0.4 * sin(0.223 * time));
    }
  },
  shapes: [],
  waves: []
...
Presets["Geiss - Oldskool Mellowstyle.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.3 * (0.6 * sin(0.633 * time) + 0.4 * sin(0.845 * time));
      wave_g =
        wave_g + 0.3 * (0.6 * sin(0.37 * time) + 0.4 * sin(0.656 * time));
      wave_b = wave_b + 0.3 * (0.6 * sin(0.74 * time) + 0.4 * sin(0.52 * time));
...
Presets["Geiss - Swirlie 4.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_x =
        wave_x + 0.29 * (0.6 * sin(2.121 * time) + 0.4 * sin(1.621 * time));
      wave_y =
        wave_y + 0.29 * (0.6 * sin(1.742 * time) + 0.4 * sin(2.322 * time));
      wave_r =
        wave_r + 0.35 * (0.6 * sin(0.823 * time) + 0.4 * sin(0.916 * time));
      wave_g =
        wave_g + 0.35 * (0.6 * sin(0.9 * time) + 0.4 * sin(1.023 * time));
      wave_b =
        wave_b + 0.35 * (0.6 * sin(0.808 * time) + 0.4 * sin(0.949 * time));
      blah = 0.5 / (wave_r + wave_g + wave_b);
      wave_r = wave_r * blah;
      wave_g = wave_g * blah;
      wave_b = wave_b * blah;
      rot = rot + 0.35 * (0.6 * sin(0.21 * time) + 0.3 * sin(0.339 * time));
      cx = cx + 0.3 * (0.6 * sin(0.374 * time) + 0.14 * sin(0.194 * time));
      cy = cy + 0.37 * (0.6 * sin(0.274 * time) + 0.1 * sin(0.394 * time));
      dx = dx + 0.01 * (0.6 * sin(0.324 * time) + 0.4 * sin(0.234 * time));
      dy = dy + 0.01 * (0.6 * sin(0.244 * time) + 0.4 * sin(0.264 * time));
...
Presets["Geiss - Swirlie 5.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_x =
        wave_x + 0.02 * (0.6 * sin(0.821 * time) + 0.4 * sin(0.621 * time));
      wave_y =
        wave_y + 0.02 * (0.6 * sin(0.942 * time) + 0.4 * sin(0.722 * time));
      wave_r =
        wave_r + 0.35 * (0.6 * sin(0.823 * time) + 0.4 * sin(0.916 * time));
      wave_g =
        wave_g + 0.35 * (0.6 * sin(0.9 * time) + 0.4 * sin(1.023 * time));
...
Presets["Krash & Rovastar - Altars of Madness (Mad Ocean Mix).milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      dx =
        dx +
        0.008 * sin((y * 2 - 1) * (48 + 12 * sin(0.412 * time))) +
        0.008 *
          sin(((y + sin(time * 0.163)) * 2 - 1) * (3 + sin(0.241 * time)));
      dy =
        dy +
        0.008 * cos((x * 2 - 1) * (64 + 18 * sin(0.376 * time))) +
        0.008 *
          cos(((x + sin(time * 0.282)) * 2 - 1) * (3 + sin(0.349 * time)));
    }
  },
  init_code: function(_) {
    with (_) {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_r =
        wave_r + 0.45 * (0.5 * sin(time * 0.701) + 0.3 * cos(time * 0.438));
      wave_b =
        wave_b - 0.4 * (0.5 * sin(time * 4.782) + 0.5 * cos(time * 0.522));
      wave_g = wave_g + 0.4 * sin(time * 1.731);
      decay = decay - equal(frame % 100, 0) * 0.1;
      vol = 0.167 * (bass + mid);
      xamptarg = ifcond(
        equal(frame % 15, 0),
        min(0.5 * vol * bass_att, 0.5),
        xamptarg
      );
      xamp = xamp + 0.5 * (xamptarg - xamp);
      xdir = ifcond(
...
Presets["Krash - Digital Flame.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      bass_thresh =
        above(bass_att, bass_thresh) * 2 +
        (1 - above(bass_att, bass_thresh)) * ((bass_thresh - 1.4) * 0.95 + 1.4);
      treb_thresh =
        above(treb_att, treb_thresh) * 2 +
        (1 - above(treb_att, treb_thresh)) * ((treb_thresh - 1.5) * 0.85 + 1.2);
      ...
      red_aim = ifcond(
        equal(swapcolour, 1),
        1,
        ifcond(equal(swapcolour, 0), 0.9, 0.7)
      );
      green_aim = ifcond(
        equal(swapcolour, 1),
        0.7,
        ifcond(equal(swapcolour, 0), 0.3, 0.6)
      );
      blue_aim = ifcond(
        equal(swapcolour, 1),
        0,
        ifcond(equal(swapcolour, 0), 0.2, 0.8)
      );
...
Presets["Krash - Dynamic Borders 1.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      ib_r = ib_r + 0.1 * (0.6 * sin(0.98 * time) + 0.4 * sin(1.047 * time));
      ib_g = ib_g + 0.1 * (0.6 * sin(0.835 * time) + 0.4 * sin(1.081 * time));
      ib_b = ib_b + 0.1 * (0.6 * sin(0.814 * time) + 0.4 * sin(1.011 * time));
...
Presets["Krash - Interwoven (Nightmare Weft Mix).milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      dy =
        0.004 +
        0.0005 * sin(10 * x + 0.459 * time) +
        0.0005 * sin(14 * x + 0.325 * time) +
        0.0005 * sin(1.231 * time);
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_x = ifcond(
        equal(framethird, 0),
        x1,
        ifcond(equal(framethird, 1), x2, x3)
      );
      wave_r = ifcond(
        equal(framethird, 0),
        r1,
        ifcond(equal(framethird, 1), r2, r3)
      );
      wave_g = ifcond(
        equal(framethird, 0),
        g1,
        ifcond(equal(framethird, 1), g2, g3)
      );
      wave_b = ifcond(
        equal(framethird, 0),
        b1,
        ifcond(equal(framethird, 1), b2, b3)
      );
      ...
      peakbass_att =
        ...
        (1 - beat) *
          peakbass_att *
          (above(time - lastbeat, 2 * beatrate) * 0.99 +
            (1 - above(time - lastbeat, 2 * beatrate)) * 0.998);
      lastbeat = beat * time + (1 - beat) * lastbeat;
      peakbass_att = max(peakbass_att, 1.1 * meanbass_att);
...
Presets["Rovastar & Geiss - Dynamic Swirls 3 (Broken Destiny Mix).milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.4 * (0.6 * sin(1.98 * time) + 0.4 * sin(1.047 * time));
      wave_g =
        wave_g + 0.4 * (0.6 * sin(1.835 * time) + 0.4 * sin(1.081 * time));
      wave_b =
        wave_b + 0.4 * (0.6 * sin(1.714 * time) + 0.4 * sin(1.011 * time));
      q8 =
        oldq8 +
        ifcond(
          above(bass + bass_att, 2.8),
          q8 + 0.005 * pow(bass + bass_att, 5),
          0
        );
      oldq8 = q8;
      q7 =
        ...
        (pow(
          ...
          fps);
      q1 = 0.62 * (0.6 * sin(0.374 * q8) + 0.4 * sin(0.294 * q8));
      q2 = 0.62 * (0.6 * sin(0.393 * q8) + 0.4 * sin(0.223 * q8));
      q3 = 0.62 * (0.6 * sin(0.174 * -q8) + 0.4 * sin(0.364 * q8));
      q4 = 0.62 * (0.6 * sin(0.234 * q8) + 0.4 * sin(0.271 * -q8));
      echo_zoom = 1 + q7;
      zoom = 1 + q7;
    }
  },
    ...
    with (_) {
      ...
      q8 =
        ...
        min(
          ifcond(
            above(bass + bass_att, 2.8),
            q8 + 0.025 * pow(bass + bass_att - 1.5, 5),
            0
          ),
          1
        );
...
Presets["Rovastar & Geiss - Surface (Vectrip Mix).milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      cx = cx + 0.11 * (0.6 * sin(0.374 * time) + 0.4 * sin(0.294 * time));
      cy = cy + 0.11 * (0.6 * sin(0.393 * time) + 0.4 * sin(0.223 * time));
      dx = dx + 0.01 * (0.6 * sin(0.173 * time) + 0.4 * sin(0.223 * time));
      vol = (bass + mid + att) / 6;
      xamptarg = ifcond(
        equal(frame % 15, 0),
        min(0.5 * vol * bass_att, 0.5),
      ...
      mv_x =
        ...
        mv_x_range *
          sin(
            mv_x_speed * ypos + (sin(time * 0.964) - 0.5 * cos(time * 0.256))
          );
      mv_y =
        mv_y_amount +
        mv_y_range +
        mv_y_range *
          sin(
            mv_y_speed * xpos - (cos(time * 1.345) - 0.5 * cos(time * 0.331))
          );
...
Presets["Rovastar & Idiot24-7 - Balk Acid.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      rot = rot + 0.1 * sin(time);
      mv_r = 0.5 + 0.5 * sin(time * 1.23);
      mv_b = 0.5 + 0.5 * sin(time * 1.26);
      mv_g = 0.5 + 0.5 * sin(time * 1.19);
      wave_g = wave_g * +0.2 * sin(time * 0.13);
      wave_r = wave_r + 0.13 * sin(time);
      wave_b = wave_b * sin(time);
      wave_x = wave_x - 0.5 * sin(time * 0.13);
    ...
    with (_) {
      ...
      movement =
        ...
        0.5 *
          ((bass +
            bass_att +
            0.075 * pow(bass + 0.6 * bass_att + 0.2 * treb_att, 3)) /
            fps);
      movement = ifcond(above(movement, 10000), 0, movement);
...
Presets["Rovastar - Chapel Of Ghouls.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      dx =
        dx +
        q1 * 0.005 * sin((y - 0.5) * meshx * q7) +
        q1 * 0.005 * sin((y - 0.5) * meshx * q4);
      dy =
        dy +
        q1 * 0.0025 * cos((x - 0.5) * meshx * q6) +
        q1 * 0.0025 * cos((x - 0.5) * meshx * q5);
    }
  },
  init_code: function(_) {
    with (_) {
...
Presets["Rovastar - Cosmic Echoes 2.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      bass_thresh =
        above(bass_att, bass_thresh) * 2 +
        (1 - above(bass_att, bass_thresh)) * ((bass_thresh - 1.4) * 0.85 + 1.4);
      treb_thresh =
        above(treb_att, treb_thresh) * 2 +
        (1 - above(treb_att, treb_thresh)) * ((treb_thresh - 1.5) * 0.75 + 1.5);
      ...
      red_aim = ifcond(
        equal(swapcolour, 1),
        1,
        ifcond(equal(swapcolour, 0), 1, 0)
      );
      green_aim = ifcond(
        equal(swapcolour, 1),
        0,
        ifcond(equal(swapcolour, 0), 0.5, 0.25)
      );
      blue_aim = ifcond(
        equal(swapcolour, 1),
        0,
        ifcond(equal(swapcolour, 0), 0, 1)
      );
      red = red + (red_aim - red) * ifcond(equal(swapcolour, 1), 0.65, 0.45);
      green = green + (green_aim - green) * 0.5;
      blue =
        blue + (blue_aim - blue) * ifcond(equal(swapcolour, 1), 0.45, 0.65);
      wave_r = red;
      wave_g = green;
      wave_b = blue;
    }
...
Presets["Rovastar - Decreasing Dreams (Extended Movement Mix).milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.2 * (0.6 * sin(0.933 * time) + 0.4 * sin(1.045 * time));
      wave_g = wave_g + 0.2 * (0.6 * sin(0.9 * time) + 0.4 * sin(0.956 * time));
      wave_b = wave_b + 0.2 * (0.6 * sin(0.91 * time) + 0.4 * sin(0.92 * time));
      warp = 0;
      zoom = 1;
      rot = 0;
      decay = 0.985;
...
Presets["Rovastar - Fractopia (Fractal Havok Mix).milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      mv_r = 0.5 + 0.499 * (0.6 * sin(3.98 * time) + 0.4 * sin(1.047 * time));
      mv_g = 0.5 + 0.499 * (0.6 * sin(0.835 * time) + 0.4 * sin(1.081 * time));
      mv_b = 0.5 + 0.499 * (0.6 * sin(0.814 * time) + 0.4 * sin(1.011 * time));
      wave_a = 0;
      warp = 0;
      movement =
        movement +
...
Presets["Rovastar - Future Speakers.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.25 * (0.6 * sin(0.933 * time) + 0.4 * sin(1.045 * time));
      wave_g =
        wave_g + 0.48 * (0.6 * sin(0.9 * time) + 0.4 * sin(0.956 * time));
      wave_b =
        wave_b + 0.37 * (0.6 * sin(0.91 * time) + 0.4 * sin(0.92 * time));
      warp = 0;
      zoom = 1;
      rot = 0;
      decay = 1;
...
Presets["Rovastar - Harlequin's Fractal Encounter.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      q1 =
        8.05 +
        0.3 * (sin(pow(x, 3) + 0.177 * time) - cos(pow(y, 3) + 0.223 * time));
      q7 = above(box, 1);
      zoom = ifcond(q7, q1 * 0.1 + q6 * 6, zoom);
      rot = ifcond(
        q7,
        0.63 *
          sin(
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      echo_zoom =
        1.32 +
        0.3 * (0.59 * sin(q4 + time * 0.865) + 0.41 * cos(q2 + time * 1.192)) +
        0.05 * bass_effect;
      volume = 0.15 * (bass_att + bass + mid + mid_att);
      beatrate = ifcond(
        equal(beatrate, 0),
...
Presets["Rovastar - Sea Shells.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      effect =
        newrad *
        ((0.9 + 0.2 * sin(q3 * 0.23)) * y) *
        ((0.9 + 0.2 * sin(q3 * 0.197)) * x);
...
Presets["Rovastar - Sunflower Passion (Simple Mix).milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r = 0.0 + 0.0 * (0.6 * sin(0.933 * time) + 0.4 * sin(1.045 * time));
      wave_g = 0.0 + 0.0 * (0.6 * sin(0.9 * time) + 0.4 * sin(0.956 * time));
      wave_b = 0.0 + 0.0 * (0.6 * sin(0.91 * time) + 0.4 * sin(0.92 * time));
      zoom = zoom + 0.01 * (0.6 * sin(0.339 * time) + 0.4 * sin(0.276 * time));
      rot = rot + 0.01 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.579 * time));
      //decay = decay - 0.01*equal(frame%6,0);
      warp = 0;
      zoom = 1;
...
Presets["Rovastar - The Awakening.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      rot = -0.4 + treb * 0.001 + sin(treb + rad) / 33 - q1 / 8;
    }
  },
  per_frame_code: function(_) {
    with (_) {
      warp = 0;
      wave_r = wave_r + 0.4 * sin(time * 0.678);
      wave_g = wave_g + 0.4 * sin(time * 0.977);
      wave_b = wave_b + 0.4 * sin(time * 0.766);
      decay = 1 - mid / 20;
      q1 = wave_r;
      wave_mystery = -time / 6;
    }
...
Presets["Rovastar and Krash - Hallucinogenic Pyramids (Extra Beat Ti.milk"] = {
      ...
      zoom =
        ifcond(
          ...
          ifcond(
            equal(q1, 1),
            0.4 * (1 - x),
            ifcond(equal(q1, 2), 0.4 * y, 0.4 * (1 - y))
          )
        ) +
        0.6 -
        0.13 * min(q2, 0.3);
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_b =
        wave_b - 0.2 * (0.6 * sin(1.823 * time) + 0.4 * sin(0.916 * time));
      wave_r = wave_r + 0.5 * (0.6 * sin(1.9 * time) + 0.4 * sin(1.023 * time));
      wave_g = wave_g + 0.5 * (0.6 * sin(1.1 * time) + 0.4 * sin(0.949 * time));
      ...
      beat_time = ifcond(
        above(bass_effect, 0.5),
        ifcond(ok_to_change, time, beat_time),
        beat_time
      );
      ...
      wave_x = ifcond(
        equal(q1, 0),
        0.01,
        ifcond(equal(q1, 1), 0.99, ifcond(equal(q1, 2), 0.01, 0.99))
      );
      wave_mystery = ifcond(
        equal(q1, 0),
        1,
        ifcond(equal(q1, 1), 1, ifcond(equal(q1, 2), 0, 0))
      );
      monitor = q1;
      zoom =
        ifcond(
...
Presets["Rovastar and Unchained - Braindance Visions.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      sy = ifcond(
        below(y, q1),
        ifcond(above(y, q2), pow(log(abs(ang) * time), 3) / 4, q1 + 0.25),
        q2 + 0.75
      );
      zoom = 1 + (sin(rad) / 10) * cos((y - 0.5 + rad) * 10 * sin(time));
      rot =
        rot + ifcond(bnot(below(y, q1) * above(y, q2)), 0, sin(time / 2) * 0.1);
    }
  },
  per_frame_code: function(_) {
    with (_) {
      bass_thresh =
        ...
        (1 - above(bass_att, bass_thresh)) * ((bass_thresh - 1.3) * 0.96 + 1.3);
      bass_residual =
        equal(bass_thresh, 2) * sin(time * bass_thresh * 0.1) +
        (1 - equal(bass_thresh, 2)) * bass_residual;
      mid_thresh =
        above(mid_att, mid_thresh) * 2 +
        (1 - above(mid_att, mid_thresh)) * ((mid_thresh - 1.3) * 0.96 + 1.3);
      mid_residual =
        equal(mid_thresh, 2) * sin(time * bass_thresh * 0.1) +
        (1 - equal(mid_thresh, 2)) * mid_residual;
      q1 = 0.75 + 0.2 * bass_residual;
      q2 = 0.25 + 0.2 * mid_residual;
      wave_g = wave_g * bass_residual;
      wave_b = wave_b * mid_residual;
      wave_r = wave_r + 0.5 * sin(time * bass_residual * mid_residual * 0.4);
      rot = rot + 0.3 * sin(time * mid_residual);
    }
  },
  shapes: [],
  waves: []
  ...
  per_pixel_code: function(_) {
    with (_) {
      rot =
        0.1 *
        (rad +
          cos(5 + 5 * sin(q8 * 1.211) * x - 0.5) -
          sin((5 + 5 * sin(q8 * 0.973)) * y - 0.5));
      dx =
        0.005 *
        (cos(5 + 5 * sin(q8 * 1.311) * x - 0.5) -
          sin((5 + 5 * sin(q8 * 0.9431)) * y - 0.5));
      dy =
        0.005 *
        (cos(5 + 5 * sin(q8 * 1.021) * x - 0.5) -
          sin((5 + 5 * sin(q8 * 0.987)) * y - 0.5));
      zoom =
        1 -
        0.005 *
          (rad +
            cos(5 + 5 * sin(q8 * 0.943) * x - 0.5) -
            sin((5 + 5 * sin(q8 * 1.0961)) * y - 0.5));
      cx = 1 - rot * 2;
    }
  },
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_r =
        -1 * cos(time) +
        abs(-1 * cos(time)) +
        0.2 * (cos(sin(time)) + (abs(cos(sin(time))) + cos(sin(time))));
      wave_r =
        1 -
        ifcond(above(wave_r, 1), 1, ifcond(above(wave_r, 0), abs(wave_r), 0));
      wave_g =
        1 -
        ifcond(above(wave_g, 1), 1, ifcond(above(wave_g, 0), abs(wave_g), 0));
      wave_b =
        1 -
        ifcond(above(wave_b, 1), 1, ifcond(above(wave_b, 0), abs(wave_b), 0));
    }
  },
  shapes: [],
  waves: []
...
Presets[
  ...
  per_pixel_code: function(_) {
    with (_) {
      dx =
        dx +
        ifcond(above(crack, rip), 2 * dx_r * crackdown, -2 * dx_r * ripdown) *
          05;
      dy =
        dy +
        ifcond(above(rip, crack), 2 * dy_r * crackdown, -2 * dy_r * ripdown) *
          05;
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      treb_changed = bnot(equal(old_treb_flop, treb_flop));
      bass_residual =
        bass_changed * sin(pulse * bass_thresh * 0.1 * entropy) +
        bnot(bass_changed) * bass_residual;
      treb_residual =
        treb_changed * sin(pulse * treb_thresh * 0.1 * entropy) +
        bnot(treb_changed) * treb_residual;
      mid_residual =
        mid_changed * sin(pulse * mid_thresh * 0.1 * entropy) +
        bnot(mid_changed) * mid_residual;
      pulse = ifcond(
        above(abs(pulse), 20),
        -20,
        pulse +
          0.1 * bor(bor(bass_changed, treb_changed), mid_changed) +
          (mid_thresh + bass_thresh + treb_thresh) * entropy * 0.025
      );
      q1 = mid_residual;
      q2 = bass_residual;
      q3 = treb_residual;
      ...
      ob_b = ifcond(treb_flop, mid_flop, wave_b);
      ob_g = ifcond(mid_flop, bass_flop, wave_g);
      ob_a = 0.03 + 0.02 * wave_r;
      ob_size = 0.25 + 0.25 * treb_residual;
      ib_size = 0.05 + 0.04 * bass_residual;
      ib_r = ifcond(bass_flop, ob_b, 0.5 + 0.2 * sin(time * 0.5413));
      ib_g = ifcond(treb_flop, ob_g, 0.5 + 0.2 * sin(time * 0.6459));
      ib_b = ifcond(mid_flop, ob_r, 0.5 + 0.2 * sin(time * 0.4354));
      rot = rot + 0.04 * q1;
...
Presets["StudioMusic & Unchained - State Of Discretion.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      radix = ifcond(above(q3, 0), min(x, y), max(x, y));
      radix = ifcond(above(q2, 0), min(radix, rad), max(radix, rad));
      rot = ifcond(above(q4, 0), rad * 0.2 * q5, 0);
      zoom = ifcond(
        above(q2, 0),
        zoom,
        ifcond(above(q3, 0), 1 + q1 * 0.05, 1 + 0.07 * cos(radix * 10 * q1))
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      pulse = ifcond(
        ...
        pulse +
          0.2 *
            bor(
              bor(
                bass_changed * bnot(treb_changed),
                treb_changed * bnot(bass_changed)
              ) * bnot(mid_changed),
              mid_changed
            ) +
          (mid + bass + treb) * entropy * 0.025
      );
      q1 = mid_residual;
      q2 = bass_residual;
      q3 = treb_residual;
      ...
      ob_g = ifcond(mid_flop, bass_flop, wave_g);
      ob_a = 0.03 + 0.02 * wave_r;
      ob_size = 0.05 + 0.04 * treb_residual;
      ib_r = ifcond(bass_flop, ob_b, ob_g);
      ib_b = ifcond(treb_flop, ob_g, ob_r);
      ib_g = ifcond(mid_flop, ob_r, ob_b);
      ib_a = 0.03 + 0.02 * wave_g;
      ib_size = 0.05 + 0.04 * bass_residual;
      ib_r = ib_r + 0.2 * sin(time * 0.5413);
      ib_g = ib_g + 0.2 * sin(time * 0.6459);
      ib_b = ib_b + 0.2 * sin(time * 0.4354);
      rot = rot + 0.04 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.579 * time));
      zoom = max(0.98, min(0.15 + 0.8 * bass_att, 1.75));
    }
  },
  shapes: [],
...
Presets["StudioMusic & Unchained - Wrenched Fate.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      radix = ifcond(above(q3, 0), min(x, y), max(x, y));
      radix = ifcond(above(q2, 0), min(radix, rad), max(radix, rad));
      rot = ifcond(above(q4, 0), rad * 0.2 * q5, rot);
      zoom = ifcond(
        above(q2, 0),
        zoom,
        ifcond(
...
Presets["Telek - Slow Shift Matrix (bb4.5).milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      bv = bass * 0.01 + 0.99 * bv;
      tt = tt + bass * 0.01;
      tt = ifcond(above(bass * bass_att, 4.5), rand(32768), tt);
      wave_x = -1;
      dx = 0.3 * sin(tt * 0.12) + 10 * sin(tt * 0.015);
      dy = 0.39 * sin(tt * 0.21) + 20 * sin(tt * 0.041);
      rot = 1 * sin(tt * 0.15);
      cx = sin(tt * 0.16) * 0.5 + 0.5;
      cy = cos(tt * 0.46) * 0.5 + 0.5;
      ib_r = sin(tt * 0.51) * 0.5 + 0.5;
      ib_g = sin(tt * 0.71) * 0.5 + 0.5;
      ib_b = sin(tt * 0.81) * 0.5 + 0.5;
      monitor = tt;
    }
  },
  shapes: [],
...
Presets["Unchained & Rovastar - For The Seagull.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      rot =
        rot +
        0.04 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.579 * time)) +
        ifcond(above(q1, 0), sin(rad) / 30, sin(1 - rad) / 30);
      zoom =
        zoom +
        0.013 * (0.6 * sin(0.339 * time) + 0.4 * sin(0.276 * time)) +
        ifcond(
          above(sin((1.123 * time) / 4), 0),
          sin(1 - rad) / 40,
          -sin(rad * q1) / 40
        );
    }
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      pulse =
        ...
        (bass + mid + treb) * 0.025;
      wave_b = ifcond(treb_changed, 1, ifcond(mid_changed, 0.45, -0.45)) * q4;
      wave_g = ifcond(bass_changed, 0.1, bass_flop);
      wave_r = ifcond(mid_flop, 1, 0.5 * q2 * treb_flop);
      ib_b = ib_b + 0.5 * sin(pulse);
      ib_g = ib_g + 5 * sin(pulse * 0.8);
      ib_r = ib_r + 5 * sin(pulse * 0.8);
      ob_b = wave_r;
      ob_g = wave_b;
      ob_r = wave_g;
...
Presets["Unchained - Goofy Beat Detection.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      rot = ifcond(above(q4, 0), rad * 0.2 * q5, sin(rad * (q4 + q3)));
      zoom = ifcond(
        above(q2, 0),
        zoom + (1 - zoom) * rot * cos(rad * 3.14 * q2),
        ifcond(
          above(q3, 0) * above(x, 0.5 + 0.5 * q5),
          zoom + (1 - zoom) * sin(q1 * rot * 3.14),
          zoom + (1 - zoom) * cos(rad * 10 * q6)
        )
      );
      dx = above(q1, 0) * sin(rad * 0.5 * q2);
      dy = above(q3, 0) * sin(rad * 0.5 * q3);
    }
  },
  per_frame_code: function(_) {
    with (_) {
      ...
      entropy = ifcond(
        equal(pulse, -20),
        1 + bass_flop + treb_flop + mid_flop + rand(2),
        entropy
      );
      bass_thresh =
        above(bass_att, bass_thresh) * 2 +
      ...
      pulse = ifcond(
        above(abs(pulse), 20),
        -20,
        pulse + (bass_thresh + mid_thresh + treb_thresh) * 0.018
      );
      q1 = mid_residual;
      q2 = bass_residual;
      q3 = treb_residual;
      ...
      q7 =
        ...
        above(q1, 0) * mid_flop;
      q8 = entropy;
      ob_r = 0.4 + 0.4 * sin(time * 2.157 + q6);
      ob_b = 0.8 + 0.2 * sin(time * 1.689 + q5);
      ob_g = 0.6 + 0.4 * sin(time * 0.413 + q4);
      ib_r = 0.5 + 0.5 * cos(time * 1.2 + q1 * 0.1);
      ib_b = 0.4 + 0.4 * cos(time * 2.811 + q2 * 0.1);
      ib_g = 0.4 + 0.4 * cos(time * 1.666 + q3 * 0.1);
      ib_size = 0.05 + 0.03 * q2;
      ob_size = 0.03 + 0.02 * sin(time * 2.321 + q2 * 0.2);
      ob_a = 0.6 + 0.4 * q3;
      ib_a = 0.9 + 0.1 * sin(q2 * 0.3 + q4 + q1 * 0.5);
      mv_r = mv_r + 0.5 * sin(q4 + time * 0.678);
      mv_b = mv_b + 0.5 * sin(q4 + time * 0.789);
      mv_g = mv_g + 0.5 * sin(q5 + time * 0.456);
      mv_a = 0.2 + 0.2 * sin(time * 1.178 + q5 * 1.14);
      rot = 0;
      wave_r = 0.6 + 0.4 * sin(q1 + time * 2.183);
      wave_b = 0.6 + 0.4 * sin(q2 + time * 1.211);
      wave_g = 0.6 + 0.4 * sin(q3 + time * 1.541);
      wave_mystery = wave_mystery + 0.5 * sin(time * 2.18 + q6);
      wave_x = wave_x + 0.3 * sin(time * 0.811) + 0.005 * (frame % 3);
      wave_y = wave_y + 0.3 * sin(time * 0.788) + 0.005 * (frame % 3);
      wave_a = 3 + sin(time * 1.414) + q3;
      wave_mode = q7;
      zoom = 1 + 0.7 * sin(time * 1.51);
    }
  },
  shapes: [],
  waves: []
...
Presets["Unchained - Shaping The Grid.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      grid = ((x * q7 * 3) % 2) + above(y, 0.5 + 0.25) * above(q6, 4);
      zoom =
        zoom +
        0.07 *
          cos(
            sin(rad * 2.14 * q3 + abs(rad - 0.1 * grid)) * 2.14 +
              rad * sin(q4 * 2.14 + q1)
          ) *
          bnot(grid);
      rot = 0.05 * equal(grid, 0) * cos(rad * 2.14 * q2 + q3) * (q2 + q3);
    }
  },
  init_code: function(_) {
    with (_) {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      old_treb_flop = treb_flop;
      old_mid_flop = mid_flop;
      chaos = 0.1 + 0.1 * sin(pulse);
      bass_thresh = ifcond(
        above(bass_att, bass_thresh),
        3,
        bass_thresh - chaos
      );
      bass_flop = abs(bass_flop - equal(bass_thresh, 3));
      treb_thresh = ifcond(
        above(treb_att, treb_thresh),
        3,
        treb_thresh - chaos
      );
      ...
      pulse = ifcond(
        above(abs(pulse), 3.14),
        -3.14,
        pulse + (bass_thresh + mid_thresh + treb_thresh) * 0.032
      );
      entropy = ifcond(
        equal(pulse, -3.14),
        bass_flop + mid_flop + treb_flop + rand(5),
        entropy
      );
      q1 = mid_residual;
      q2 = bass_residual;
      ...
      wave_r = wave_r + 0.5 * sin(q1 + q2 * 2 + q4 * 2.1);
      wave_b = wave_b + 0.5 * sin(q2 + q3 * 2 + q4 * 2.2);
      wave_g = wave_g + 0.5 * sin(q3 + q1 * 2 + q4 * 2.3);
      ob_r = ifcond(bass_flop, ob_r + 0.5 * sin(q1 + q3 * 1.14 + q2), wave_b);
      ob_b = ifcond(treb_flop, ob_b + 0.5 * sin(q2 + q1 * 1.14 + q3), wave_g);
      ob_g = ifcond(mid_flop, ob_g + 0.5 * sin(q3 + q2 * 1.14 + q1), wave_r);
      ib_r = ifcond(bass_flop, ob_b, ib_r + 0.5 * cos(q5 + q1 * 2.14));
      ib_b = ifcond(treb_flop, ob_g, ib_b + 0.5 * cos(q5 + q2 * 2.14));
      ib_g = ifcond(mid_flop, ob_r, ib_g + 0.5 * cos(q5 + q3 * 2.14));
      mv_r = mv_r + 0.5 * sin(q4 + q5 * 1.14 * q1);
      mv_b = mv_b + 0.5 * sin(q4 + q5 * 1.14 * q2);
      mv_g = mv_g + 0.5 * sin(q5 + q5 * 1.14 * q3);
      ob_a = 0.25 + 0.25 * sin(q2 + q3 * 2.14);
      ib_a = 0.5 + 0.5 * sin(q2 * 2.14 + q3);
      mv_a = mv_a + mv_a * sin(q3 * 2.14 + q2);
      ob_size = 0.1 + 0.1 * sin(q3 * 3 + q1);
      ib_size = ib_size * 0.5 + ib_size * 0.25 * sin(q1 * 3 + q3);
      wave_mode = q6 + above(q4, 0) + above(q5, 0);
      wave_mystery = sin(q3 * 1.14 + q1 * 1.14 + q2);
      mv_l = q6 * q7 * q2;
      wave_x = wave_x + 0.1 * q7 * q4;
      wave_y = wave_y + 0.1 * q6 * q5;
      mv_x = q6 * q7;
      mv_y = q6 * q7;
      monitor = q1;
    }
...
Presets["Unchained - ReAwoke.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      xx = (x - 0.5 + 0.03 * q5 + 0.1 * y * q6 + 0.1 * sin(time * 0.322)) * 2;
      yy = (y - 0.5 + 0.03 * q6 + 0.1 * x * q5 + 0.1 * sin(time * 0.427)) * 2;
      dx = sin(xx);
      dy = sin(yy);
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      q7 =
        ...
        above(q1, 0) * mid_flop;
      q8 = entropy;
      ob_r = 0.2 + 0.1 * sin(time * 2.157 + q6);
      ob_b = 0.2 + 0.1 * sin(time * 1.689 + q5);
      ob_g = 0.2 + 0.1 * sin(time * 0.413 + q4);
      ib_r = 0.8 + 0.2 * cos(time * 1.2 + q1 * 0.1);
      ib_b = 0.2 + 0.2 * cos(time * 2.811 + q2 * 0.1);
      ib_g = 0.7 + 0.3 * cos(time * 1.666 + q3 * 0.1);
      ib_size = 0.1 + 0.05 * q2;
      ob_size = 0.03 + 0.02 * sin(time * 2.321 + q2 * 0.2);
      ob_a = 0.75 + 0.25 * q3;
      ib_a = 0.8 + 0.2 * sin(q2 * 0.3 + q4 + q1 * 0.5);
      mv_r = mv_r + 0.5 * sin(q4 + time * 0.678);
      mv_b = mv_b + 0.5 * sin(q4 + time * 0.789);
      mv_g = mv_g + 0.5 * sin(q5 + time * 0.456);
      mv_a = 0.2 + 0.2 * sin(time * 1.178 + q5 * 1.14);
...
Presets["Unchained - In Memory Of Peg.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_b = 0.6 + 0.4 * sin(q2 + time * 1.211);
      wave_g = 0.6 + 0.4 * sin(q3 + time * 1.541);
      wave_mystery = wave_mystery + 0.3 * sin(time * 2.18 + q6);
      wave_x = wave_x + 0.3 * sin(time * 0.811) + 0.005 * (frame % 3);
      wave_y = wave_y + 0.3 * sin(time * 0.788) + 0.005 * (frame % 3);
      wave_a = 3 + sin(time * 1.414) + q3;
      zoom = zoom + 0.5 * sin(time * 1.69);
    }
  },
  shapes: [],
  waves: []
...
Presets["Bmelgren - Pentultimate Nerual Slipstream (Tweak 2).milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ray = pow(rad, 1.8) + 0.05;
      zoom = (ray / rad) * 1.4 + 0.3 * sin(ang * (bass * 5)) + bass * 0.2;
    }
  },
  per_frame_code: function(_) {
    with (_) {
      warp = 0;
      wave_r = wave_r + 0.5 * sin(time * 333) + bass * 0.3;
      wave_g = wave_g + 0.5 * sin(time * 222) + treb * 0.3;
      wave_b = wave_b + 0.5 * sin(time * 111) + mid * 0.3;
      rot = 0.4 * sin(mid_att * 0.05);
    }
  },
  shapes: [],
  waves: []
...
Presets["Eo.S.+Phat Fractical_dancer - pulsate box_mix.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      zoom = pow(rd, sin(time) + 3.5) / 10.5 + 0.5;
    }
  },
  init_code: function(_) {
    with (_) {
...
Presets["fiShbRaiN - crazy diamond.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      cx = 0.5 + sin(time) * 0.2;
      cy = 0.5 + sin(time * 0.3) * 0.1;

      rot = rot + treb * bass * 0.01;

      warp = warp + ifcond(above(bass, 1.4), bass * 8 * sin(time * 0.2), bass);
    }
  },
  shapes: [
    {
    ...
    },
    {
      ...
      per_frame_code: function(_) {
        with (_) {
          ...
          x = sin(time + 0.23) * 0.5 + 0.5;
          y = cos(time * 0.21) * 0.5 + 0.5;
          ang = time;
        }
      }
    },
    ...
    },
    {
      ...
      per_point_code: function(_) {
        with (_) {
          ...
          //base
          wx = ifcond(equal(sc, 0), 0.5, wx);
          wy = ifcond(equal(sc, 0), 0.1, wy);

          wx = ifcond(equal(sc, 1), 0.5, wx);
          wy = ifcond(equal(sc, 1), 0.4, wy);

          //calculate previous branch length
          d = ifcond(below(sc, 2), 0.3, 0.7 * d);

          //angle
          wainc = ifcond(equal(branch, 1), 0.2, -0.2);

          wa = ifcond(below(sc, 2), 3.1415927 * 0.5, wa + wainc);
  ...
  waves: [
    {
      ...
      per_point_code: function(_) {
        with (_) {
          ...
          //angle
          wainc = ifcond(equal(branch, 1), 0.2 + tren * 0.1, -0.2 - treb * 0.1);
...
Presets["fiShbRaiN - plasma temptation.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      zoom = zoom + sin(x * treb * mid * 0.1) * direc * -1;
  ...
  shapes: [
    {
      ...
      per_frame_code: function(_) {
        with (_) {
          x = (sin(time) + 1) * 0.5;
          y = bass_att * 0.5 + sin(time * 0.5) * 0.2;
    ...
    },
    {
      ...
      per_frame_code: function(_) {
        with (_) {
          x = (cos((time + 0.233) * 0.2) + 1) * 0.5;
          y = (sin(time * 0.1) + 1) * 0.5 + sin(time * 0.13) * 0.5;
...
Presets["Geiss - Octopus.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 1.0 * (0.6 * sin(1.517 * time) + 0.4 * sin(1.58 * time));
      wave_g =
        wave_g + 1.0 * (0.6 * sin(1.088 * time) + 0.4 * sin(1.076 * time));
      wave_b =
        wave_b + 1.0 * (0.6 * sin(1.037 * time) + 0.4 * sin(0.922 * time));
      rot = rot + 0.04 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.579 * time));
      cx = cx + 0.11 * (0.6 * sin(0.374 * time) + 0.4 * sin(0.294 * time));
      cy = cy + 0.11 * (0.6 * sin(0.393 * time) + 0.4 * sin(0.223 * time));
      q1 = cos(1.41 * time);
...
Presets["Geiss - Swirlie 3.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_g = wave_g * blah;
      wave_b = wave_b * blah;
      rot = rot + 0.12 * (0.6 * sin(0.21 * time) + 0.4 * sin(0.339 * time));
      cx = cx + 0.3 * (0.6 * sin(0.374 * time) + 0.14 * sin(0.194 * time));
      cy = cy + 0.37 * (0.6 * sin(0.274 * time) + 0.1 * sin(0.394 * time));
      ib_r = ib_r + 0.2 * sin(time * 0.5413);
      ib_g = ib_g + 0.2 * sin(time * 0.6459);
...
Presets["Geiss - The Fatty Lumpkin Sunkle Tweaker.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_x =
        wave_x + 0.25 * (0.6 * sin(2.121 * time) + 0.4 * sin(1.621 * time));
      wave_y =
        wave_y + 0.25 * (0.6 * sin(1.742 * time) + 0.4 * sin(2.322 * time));
      wave_r =
        wave_r + 0.5 * (0.6 * sin(0.823 * time) + 0.4 * sin(0.916 * time));
      wave_g = wave_g + 0.5 * (0.6 * sin(0.9 * time) + 0.4 * sin(1.023 * time));
      wave_b =
        wave_b + 0.5 * (0.6 * sin(0.808 * time) + 0.4 * sin(0.949 * time));
      zoom = zoom + 0.01 * (0.6 * sin(0.339 * time) + 0.4 * sin(0.276 * time));
      rot = rot + 0.035 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.539 * time));
      cx = cx + 0.03 * (0.6 * sin(0.374 * time) + 0.4 * sin(0.194 * time));
      cy = cy + 0.037 * (0.6 * sin(0.274 * time) + 0.4 * sin(0.394 * time));
      q = time;
      dx = dx + 0.019 * (0.6 * sin(100.334 * q) + 0.4 * sin(250.277 * q));
      dy = dy + 0.019 * (0.6 * sin(200.384 * q) + 0.4 * sin(150.247 * q));
      sx = sx + 0.01 * (0.6 * sin(0.313 * time) + 0.4 * sin(0.383 * time));
    }
  },
  shapes: [],
  waves: []
...
Presets["Illusion & Unchained - Invade My Mind.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      zoom = zoom + 0.1 * sin(q4 + time + ang + rad);
      rot =
        ifcond(
          above(bnot(1 * q4), bnot(1 * q3 * 0.24)),
          rot * sin(rad * sin(q4 * 0.54)),
          -rot * sin(rad * cos(q4 * 0.34))
        ) *
        sin(bass * 0.43) *
        sin(time * 0.13) *
        sin(q4 * 0.54);
      sx = sx + 0.2 * sqrt(sin(x)) * sin(q3) * sin(q4 * 0.42) * sin(q1 * 0.65);
      sy =
        sy -
        0.2 *
          sqrt(sin(y)) *
          cos(q3 * q1) *
          sin(above(q3, q3 + 0.4) * 0.54) *
          sin(q4 * above(q3, q2) * 0.54);
      dx =
        rot *
        sin(q4 + q3) *
        Y *
        sin(above(q2, q4 * 0.12)) *
        x *
        sin(q3 * 0.53) *
        sin(q5 * 0.43);
      dy =
        ...
        sin(q3) *
        x *
        sin(above(q3, q5) * 0.53) *
        y *
        sin(above(q4, q1) * -0.12) *
        sin(above(q1, q3) * 0.23);
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_mystery = 0.5 * q6;
      warp = 0;
      ob_size = 0.07 + (bass + mid) / 24 + bass_att / 30;
      ib_size = ob_size / 4;
    }
  },
  shapes: [],
...
Presets["Krash & Illusion - Spiral Movement.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      wave_b =
        wave_b + 0.35 * (0.6 * sin(0.814 * time) + 0.4 * sin(1.011 * time));
      rot = rot + 0.03 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.479 * time));
      cx = cx + 0.41 * (0.6 * sin(0.374 * time) + 0.4 * sin(0.294 * time));
      cy = cy + 0.41 * (0.6 * sin(0.393 * time) + 0.4 * sin(0.223 * time));
      wave_mystery =
        wave_mystery +
        0.15 * (0.6 * sin(0.629 * time) + 0.4 * sin(1.826 * time));
      warp = warp * vol;
      zoom = zoom - 0.02 * zoom * bass_att;
      zoom_exp = 1.5 * (0.6 * sin(0.381 * time) + 0.4 * sin(0.479 * time));
      ob_a = 1 - 2 * vol;
      monitor = zoom_exp;
    }
  },
...
Presets["Rovastar & Fvese - Stranger Minds (Astral Mix).milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.35 * (0.6 * sin(0.825 * time) + 0.4 * sin(0.915 * time));
      wave_g =
        wave_g + 0.35 * (0.6 * sin(0.9 * time) + 0.4 * sin(1.025 * time));
      wave_b =
        wave_b + 0.35 * (0.6 * sin(0.81 * time) + 0.4 * sin(0.95 * time));
      mv_r = wave_r + 0.35 * (0.6 * sin(0.9 * time) + 0.4 * sin(0.75 * time));
      mv_g = wave_g + 0.35 * (0.6 * sin(0.825 * time) + 0.4 * sin(0.95 * time));
      mv_b =
        wave_b + 0.35 * (0.6 * sin(0.775 * time) + 0.4 * sin(1.025 * time));
...
Presets["Rovastar - Fractopia (Focused Childhood Mix ).milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      xamptarg = ifcond(
        equal(frame % 15, 0),
        min(0.25 * volume * ((60 * bass_att) / fps), 0.5),
        xamptarg
      );
      xamp = xamp + 0.5 * (xamptarg - xamp);
      xdir = ifcond(
      ...
      yamptarg = ifcond(
        equal(frame % 15, 0),
        min(0.15 * volume * ((60 * treb_att) / fps), 0.5),
        yamptarg
      );
      yamp = yamp + 0.5 * (yamptarg - yamp);
      ydir = ifcond(
...
Presets["Rovastar - Hallucinogenic Pyramids (Beat Time Mix).milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      bass_effect = max(max(bass, bass_att) - 1.34, 0);
      zoom =
        ifcond(above(effect, 0), 0.4 * x, 0.4 * y) +
        0.6 -
        0.13 * min(bass_effect, 0.3);
    }
  },
  per_frame_code: function(_) {
    with (_) {
      wave_r =
        wave_r + 0.2 * (0.6 * sin(0.823 * time) + 0.4 * sin(0.916 * time));
      wave_g = wave_g + 0.5 * (0.6 * sin(0.9 * time) + 0.4 * sin(1.023 * time));
      wave_b =
        wave_b + 0.5 * (0.6 * sin(0.808 * time) + 0.4 * sin(0.949 * time));
      decay = decay - 0.03 * equal(frame % 30, 0);
...
Presets["Rovastar - Torrid Tales.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      warp = 0;
      ib_r = 0.5 + 0.5 * (0.6 * sin(0.814 * time) + 0.4 * sin(1.011 * time));
...
Presets["Rozzor & Aderrasi - Canon.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      rot =
        rot + 0.3 * (0.2 * sin(1 - rad) * 5 - 0.2 * sin(0.05 * rad) * 5) * q2;
      cx = ifcond(above(dy, -0.5), 1 - rot * 2, rot * q2);
    }
  },
  per_frame_code: function(_) {
    with (_) {
      ...
      ob_r = ifcond(
        above(wave_r, 1),
        1,
        ifcond(above(wave_r, 0), abs(wave_r), 0)
      );
      ob_g = ifcond(
        above(wave_g, 1),
        1,
        ifcond(above(wave_g, 0), abs(wave_g), 0)
      );
      ob_b = ifcond(
        above(wave_b, 1),
        1,
        ifcond(above(wave_b, 0), abs(wave_b), 0)
      );
      ib_g = wave_g;
      ib_r = sin(time);
      kick =
        above(bass_att, kick) * 2 +
        (1 - above(bass_att, kick)) * ((kick - 1.3) * 0.96 + 1.3);
      dx_r =
        equal(kick, 2) * 0.018 * sin(6 * time) + (1 - equal(kick, 2)) * dx_r;
      dy_r =
        equal(kick, 2) * 0.015 * sin(7 * time) + (1 - equal(kick, 2)) * dy_r;
...
Presets["Rozzor & Che - Inside The House Of Nil.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      zoom =
        1 +
        above(sin(1.7 * q2), -0.5) *
          0.1 *
          sin(
            2 * q2 +
              0.027 * q1 +
              4 * (1 + sin(0.7 * time + q2)) * sin(0.05 * q2 + time) * rad
          );
      rot =
        0.1 *
        sin(q2) *
        sin(
          2.3 * q2 +
            0.027 * q1 +
            2 *
              sin(0.07 * q1 + 1.2 * time) *
              (rad + sin(time + above(sin(q2), 0) * 4 * sin(q2) * ang))
        );
      rot = above(sin(1.2 * q2 + 1.3), -0.5) * rot;
    }
  },
  per_frame_code: function(_) {
    with (_) {
      slowtime = slowtime + beat * time;
      vol_now = 0.4 * bass + 0.1 * (bass_att + treb + mid);
      vol_mean = ifcond(
        equal(frame % 50, 0),
        vol_mean - 0.5 * (vol_mean - vol_now),
        0.1 * (vol_mean * 9 + vol_now)
      );
      ...
      wave_r = ifcond(
        redneg,
        ifcond(bor(greenneg, blueneg), 1, 1 + mv_r),
        mv_r
      );
      wave_g = ifcond(
        greenneg,
        ifcond(equal(greenneg + blueneg, 2), 1, 1 + mv_g),
        mv_g
      );
      wave_b = ifcond(blueneg, 1 + mv_b, mv_b);
      dx = sin(slowtime * 1.234) * 0.0125;
      dy = cos(slowtime * 0.9666) * 0.0125;
      q1 = sin(slowtime);
      q2 = wave_b;
    }
  },
...
Presets["StudioMusic - It's Only Make Believe.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      ob_g = wave_g;
      ob_b = wave_b;
      rot = rot + 0.18 * (0.6 * sin(0.981 * time) + 0.8 * sin(0.279 * time));
      zoom = max(0.98, min(0.15 + 0.8 * bass_att, 1.75));
    }
  },
  shapes: [],
...
Presets["Unchained & Rovastar - Triptionary.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      ...
      old_treb_flop = treb_flop;
      old_mid_flop = mid_flop;
      chaos = 0.9 + 0.1 * sin(beat);
      entropy = ifcond(
        bnot(entropy),
        2,
        ifcond(equal(pulse, -3.14), 1 + rand(3), entropy)
      );
      bass_thresh =
        above(bass_att, bass_thresh) * 2 +
        (1 - above(bass_att, bass_thresh)) *
      ...
      pulse = ifcond(
        above(abs(pulse), 3.14),
        -3.14,
        pulse + (bass_thresh + mid_thresh + treb_thresh) * 0.052
      );
      beat = ifcond(
        above(abs(beat), 3.14),
        -3.14,
        beat + (bass + treb + mid) * 0.052
      );
      q1 = mid_residual;
      q2 = bass_residual;
      q3 = treb_residual;
      ...
      q5 = sin(beat);
      wave_r = wave_r + 0.5 * bass_residual;
      wave_g = wave_g + 0.5 * mid_residual;
      wave_b = wave_b + 0.5 * treb_residual;
      ob_r = ifcond(bass_flop, treb_flop, wave_r);
      ob_b = ifcond(treb_flop, mid_flop, wave_b);
      ob_g = ifcond(mid_flop, bass_flop, wave_g);
      ob_a = 0.05 + 0.05 * cos(wave_r + pulse * 0.03);
...
Presets["Unchained - Beat Demo 1.0.milk"] = {
  ...
  per_frame_code: function(_) {
    with (_) {
      warp = 0;
      chaos = 0.9 + 0.1 * sin(pulse - beat);
      entropy = ifcond(
        bnot(entropy),
        2,
        ifcond(equal(pulse, -20) * above(beat, 0), 1 + rand(5), entropy)
      );
      bass_thresh =
        above(bass_att, bass_thresh) * 2 +
        (1 - above(bass_att, bass_thresh)) *
      ...
      pulse = ifcond(
        above(abs(pulse), 20),
        -20,
        pulse + (mid + bass + treb) * 0.025
      );
      beat = ifcond(
        above(abs(beat), 20),
        -20,
        beat + 0.1 * chaos * bor(bor(bass_changed, treb_changed), mid_changed)
      );
      q3 = sin(pulse);
      q2 = sin(pulse + beat);
      q4 = sin(beat);
      ...
      q1 =
        (1 + 1 * above(q2, 0)) *
        (1 + 2 * above(q3, 0)) *
        (1 + 4 * mid_changed * above(q3, 0)) *
        (1 + 6 * above(q4, 0)) *
        (1 + 10 * bass_changed * above(q4, 0)) *
        (1 + 12 * above(q5, 3)) *
        (1 + 16 * treb_changed * above(q2, 0));
      wave_r =
        0.5 +
        0.2 * bnot(q1 % 2) -
        0.2 * bnot(q1 % 3) +
      ...
      wave_g =
        ...
        0.2 * bnot(q1 % 13) +
        0.3 * q4 * bnot(q1 % 7);
      wave_b = ifcond(bnot(q1 % 6), 0.8 + 0.2 * q4, 0.5 + 0.5 * q2);
      ob_r = ob_r + 0.2 * q2 + 0.3 * bnot(q1 % 13) * q3;
      ob_b = ob_b - 0.1 * bnot(q1 % 105) - 0.4 * q2;
      ob_g = ob_g + 0.5 * sin(pulse * 0.4 * entropy);
      ob_a = 0.07 + 0.05 * q3;
      ob_size = 0.01 * entropy * bnot(q1 % 6);
      ib_r = ib_r + 0.2 * q1 - 0.3 * bnot(q1 % 3) * q4;
      ib_b = ib_b - 0.2 * bnot(q1 % 17) - 0.3 * q2 + 0.2 * bnot(q1 % 11);
      ib_g = ib_g + 0.5 * sin(pulse * 0.35 * entropy);
      ib_a = 0.07 + 0.05 * q3 * q4;
      ib_size = 0.005 + 0.005 * q3;
      zoom_fade = ifcond(
        bnot(q1 % 2),
        zoom_fade - (zoom_fade - 0.97) / 2,
        zoom_fade -
          bnot(q1 % 5) * 0.02 * q4 +
          bnot(q1 % 2) * 0.02 * q3 -
          bnot(q1 % 11) * 0.04 * q2
      ...
      rot_fade = ifcond(
        bnot(q1 % 7),
        rot_fade - (rot_fade - 0.1 * q3) / 2 - 0.03 * bnot(q1 % 13),
        rot_fade -
          0.02 * bnot(q1 % 11) +
          0.02 * bnot(q1 % 3) +
          0.03 * bnot(q1 % 35)
      ...
      cx =
        ...
        0.07 * bnot(q1 % 13) * q3 -
        0.2 * bnot(q1 % 55) * q4;
      wave_x = wave_x + 0.1 * q3 + 0.2 * q4 * bnot(q1 % 2);
    }
  },
  shapes: [],
  waves: []
  ...
  per_pixel_code: function(_) {
    with (_) {
      ...
      zoom = ifcond(
        ...
        ifcond(
          below(abs(q2), 0.5),
          1 + 0.07 * sin(q4 * 3.14 * radix),
          1 + 0.07 * sin(radix * q8 * q4 * 1.618)
        )
      );
    }
  },
  ...
  per_pixel_code: function(_) {
    with (_) {
      rot = ifcond(
        above(q4, 0),
        rad * 0.2 * q5,
        rot + 0.3 * sin(ang * 3.14 * (q1 + q2 + q3))
      );
      zoom = ifcond(
        above(q2, 0),
        zoom - cos(rad * 3.14 * q2) * 0.1,
        ifcond(above(q3, 0), 1 + q1 * 0.05, 1 + 0.07 * cos(ang * 10 * q1))
      );
    }
  },
  per_frame_code: function(_) {
    with (_) {
      ...
      pulse = ifcond(
        ...
        -20,
        pulse +
          (bass_thresh + mid + thresh + treb_thresh) * 0.035 -
          (bass + treb + mid) * 0.01
      );
      q1 = mid_residual;
      q2 = bass_residual;
      ...
      mv_b = wave_g;
      mv_g = wave_r;
      cx = cx + sin(pulse * q3) * 0.1;
      cy = cy + sin(pulse * q2) * 0.1;
    }
  },
  shapes: [],
  waves: []
...
Presets["Unchained - Subjective Experience Of The Manifold.milk"] = {
  ...
  per_pixel_code: function(_) {
    with (_) {
      xx = x - 0.5 + 0.03 * q5 + 0.1 * y * q6 + 0.1 * sin(time * 0.322);
      yy = y - 0.5 + 0.03 * q6 + 0.1 * x * q5 + 0.1 * sin(time * 0.427);
      dx = sin(xx * 2);
      dy = sin(yy * 2);
      rot = sin(rad * 1.4 + 0.3 * q4);
    }
  },
  per_frame_code: function(_) {
    with (_) {
      ...
      pulse = ifcond(
        above(abs(pulse), 20),
        -20,
        pulse + (bass_thresh + mid_thresh + treb_thresh) * 0.008
      );
      q1 = mid_residual;
      q2 = bass_residual;
      q3 = treb_residual;
      ...
      q7 =
        ...
        above(q1, 0) * mid_flop;
      q8 = entropy;
      ob_r = 0.2 + 0.2 * sin(time * 2.157);
      ob_b = 0.2 + 0.2 * sin(time * 1.689);
      ob_g = 0.2 + 0.2 * sin(time * 1.413);
      ib_r = 0.8 + 0.2 * cos(time * 1.2 + q1 * 0.1);
      ib_b = 0.2 + 0.2 * cos(time * 2.811 + q2 * 0.1);
      ib_g = 0.7 + 0.3 * cos(time * 1.666 + q3 * 0.1);
      ib_size = 0.03 + 0.02 * q2;
      ...
      rot = 0;
      echo_zoom =
        1 + 0.08 * q1 + 0.08 * q2 + 0.06 * q3 + 0.16 * cos(time * 0.681);
      wave_r = 0.5 + 0.5 * sin(q1 + time * 2.183);
      wave_b = 0.5 + 0.5 * sin(q2 + time * 1.211);
      wave_g = 0.5 + 0.5 * sin(q3 + time * 1.541);
      wave_mystery = wave_mystery + 0.5 * sin(time * 3 + q6);
      wave_x = wave_x + 0.3 * sin(time * 0.811) + 0.005 * (frame % 3);
      wave_y = wave_y + 0.3 * sin(time * 0.788) + 0.005 * (frame % 3);
      wave_mode = q8 % 3;
      wave_a = 3 + sin(time * 1.414) + q3;
